 ...
 * {@code ModifyDNForwardFailedAccessLogMessage} class.
 */
public class ModifyDNForwardFailedAccessLogMessageTestCase
       extends LDAPSDKTestCase
{
         ...
         throws Exception
  {
    ...
    ModifyDNForwardFailedAccessLogMessage m =
         new ModifyDNForwardFailedAccessLogMessage(s);
    m = new ModifyDNForwardFailedAccessLogMessage(m);
         ...
         throws Exception
  {
    ...
    SimpleDateFormat f = new SimpleDateFormat("'['dd/MMM/yyyy:HH:mm:ss Z']'");
    String s = f.format(d) + " MODDN FORWARD-FAILED conn=1 op=2 msgID=3 " +
