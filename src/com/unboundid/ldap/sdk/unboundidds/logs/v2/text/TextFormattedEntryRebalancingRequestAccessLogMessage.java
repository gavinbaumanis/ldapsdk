       ...
       implements EntryRebalancingRequestAccessLogMessage
{
   ...
   *                        log message.
   */
  public TextFormattedEntryRebalancingRequestAccessLogMessage(
   ...
   *                     request access log message.  It must not be
   *                     {@code null}.
   */
       ...
       @NotNull final TextFormattedLogMessage logMessage)
  {
    ...
    rebalancingOperationID = getLongNoThrow(
         TextFormattedAccessLogFields.ENTRY_REBALANCING_OPERATION_ID);
    ...
    subtreeBaseDN = getString(
         TextFormattedAccessLogFields.ENTRY_REBALANCING_BASE_DN);
    sizeLimit = getIntegerNoThrow(
         TextFormattedAccessLogFields.ENTRY_REBALANCING_SIZE_LIMIT);
    sourceBackendSetName = getString(
         TextFormattedAccessLogFields.ENTRY_REBALANCING_SOURCE_BACKEND_SET);
    sourceBackendServer = getString(
         TextFormattedAccessLogFields.ENTRY_REBALANCING_SOURCE_SERVER);
    targetBackendSetName = getString(
         TextFormattedAccessLogFields.ENTRY_REBALANCING_TARGET_BACKEND_SET);
    targetBackendServer = getString(
         TextFormattedAccessLogFields.ENTRY_REBALANCING_TARGET_SERVER);
  }
