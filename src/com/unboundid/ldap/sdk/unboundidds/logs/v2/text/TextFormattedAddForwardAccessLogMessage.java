...
import com.unboundid.ldap.sdk.unboundidds.logs.v2.AddForwardAccessLogMessage;
 ...
 * text-formatted add forward access log message.
 * <BR>
 * <BLOCKQUOTE>
...
public class TextFormattedAddForwardAccessLogMessage
       extends TextFormattedAddRequestAccessLogMessage
       implements AddForwardAccessLogMessage
{
  /**
   * The serial version UID for this serializable class.
   */
  private static final long serialVersionUID = -4824569892291919972L;
  ...
  /**
   * Creates a new text-formatted add forward access log message from the
   ...
   *                        log message.
   */
  public TextFormattedAddForwardAccessLogMessage(
