...
public interface InMemoryInterceptedSimpleBindResult
       extends InMemoryInterceptedResult
{
  /**
   * Retrieves the simple bind request that was processed.  If the request was
   ...
   *
   * @return  The simple bind request that was processed.
   */
  @NotNull()
