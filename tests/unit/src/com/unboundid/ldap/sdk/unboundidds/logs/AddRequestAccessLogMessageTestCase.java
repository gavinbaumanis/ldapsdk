 ...
 * {@code AddRequestAccessLogMessage} class.
 */
public class AddRequestAccessLogMessageTestCase
       extends LDAPSDKTestCase
{
         ...
         throws Exception
  {
    ...
    AddRequestAccessLogMessage m = new AddRequestAccessLogMessage(s);
    m = new AddRequestAccessLogMessage(m);
         ...
         throws Exception
  {
    ...
    SimpleDateFormat f = new SimpleDateFormat("'['dd/MMM/yyyy:HH:mm:ss Z']'");
    String s = f.format(d) + " ADD REQUEST conn=1 op=2 msgID=3 " +
         ...
         throws Exception
  {
    ...
    String s = f.format(d) + " ADD REQUEST " +
               ...
               "dn=\"dc=example,dc=com\" attrs=\"objectClass,dc\" " +
    ...
    assertTrue(m.getAttributeNames().contains("dc"));
