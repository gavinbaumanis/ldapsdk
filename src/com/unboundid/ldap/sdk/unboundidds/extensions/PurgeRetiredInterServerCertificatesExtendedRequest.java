...
public final class PurgeRetiredInterServerCertificatesExtendedRequest
       extends ExtendedRequest
{
   ...
   */
  private static final long serialVersionUID = 2390802711515142192L;
   ...
   */
  public PurgeRetiredInterServerCertificatesExtendedRequest(
              @Nullable final Control... requestControls)
  {
    super(PURGE_RETIRED_INTER_SERVER_CERTS_REQUEST_OID, null, requestControls);
  }
   ...
   *                         inter-server certificates request.
   */
  public PurgeRetiredInterServerCertificatesExtendedRequest(
  ...
  {
    return INFO_PURGE_RETIRED_INTER_SERVER_CERTS_REQUEST_NAME.get();
  }
  ...
  {
    buffer.append("PurgeRetiredInterServerCertificatesExtendedRequest(oid='");
