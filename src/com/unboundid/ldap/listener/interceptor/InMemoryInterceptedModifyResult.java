...
public interface InMemoryInterceptedModifyResult
       extends InMemoryInterceptedResult
{
  /**
   * Retrieves the modify request that was processed.  If the request was
   ...
   *
   * @return  The modify request that was processed.
   */
  @NotNull()
   ...
   *
   * @return  The modify result to be returned to the client.
   */
  @Nullable()
   ...
   *
   * @param  modifyResult  The modify result that should be returned to the
   *                       client instead of the result originally generated by
   *                       the in-memory directory server.  It must not be
   *                       {@code null}.
   */
  void setResult(@NotNull LDAPResult modifyResult);
