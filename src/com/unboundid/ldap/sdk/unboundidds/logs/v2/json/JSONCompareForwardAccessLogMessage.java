 ...
 * JSON-formatted compare forward access log message.
 * <BR>
 * <BLOCKQUOTE>
...
public class JSONCompareForwardAccessLogMessage
       ...
       implements CompareForwardAccessLogMessage
{
   ...
   */
  private static final long serialVersionUID = -3714314814567308804L;
  ...
  /**
   * Creates a new JSON compare forward access log message from the provided
   * JSON object.
   *
   ...
   *                        valid log message.
   */
  public JSONCompareForwardAccessLogMessage(
