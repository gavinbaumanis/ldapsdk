 ...
 * text-formatted compare result access log message.
 * <BR>
 * <BLOCKQUOTE>
...
public final class TextFormattedCompareResultAccessLogMessage
       ...
       implements CompareResultAccessLogMessage
{
   ...
   */
  private static final long serialVersionUID = -5496273839182307779L;
   ...
   *                        log message.
   */
  public TextFormattedCompareResultAccessLogMessage(
   ...
   * provided message.
   *
   * @param  logMessage  The log message to use to create this compare result
