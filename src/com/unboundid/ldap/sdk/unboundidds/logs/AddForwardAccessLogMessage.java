...
public final class AddForwardAccessLogMessage
       extends AddRequestAccessLogMessage
{
  ...
  /**
   * Creates a new add forward access log message from the provided message
   * string.
   *
   * @param  s  The string to be parsed as an add forward access log message.
   *
   * @throws  LogException  If the provided string cannot be parsed as a valid
   *                        log message.
   */
  public AddForwardAccessLogMessage(@NotNull final String s)
         throws LogException
  {
   ...
   *
   * @param  m  The log message to be parsed as an add forward access log
   *            message.
   */
  public AddForwardAccessLogMessage(@NotNull final LogMessage m)
  {
    super(m);
