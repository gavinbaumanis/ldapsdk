 ...
 */
public class ControlMessagesTestCase
       extends LDAPSDKTestCase
{
  ...
  public void testMessageDefined(final ControlMessages m)
         throws Exception
  {
    assertNotNull(m);

    assertEquals(ControlMessages.valueOf(m.name()), m);
  ...
  {
    ControlMessages[] values = ControlMessages.values();
