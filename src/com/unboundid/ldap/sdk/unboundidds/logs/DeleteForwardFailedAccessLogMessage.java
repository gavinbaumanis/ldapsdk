...
public final class DeleteForwardFailedAccessLogMessage
       extends DeleteRequestAccessLogMessage
{
  ...
  /**
   * Creates a new delete forward failed access log message from the provided
   * message string.
   *
   * @param  s  The string to be parsed as a delete forward failed access log
   *            message.
   *
   * @throws  LogException  If the provided string cannot be parsed as a valid
   *                        log message.
   */
  public DeleteForwardFailedAccessLogMessage(@NotNull final String s)
         throws LogException
  {
   ...
   * log message.
   *
   * @param  m  The log message to be parsed as a delete forward failed access
   *            log message.
   */
  public DeleteForwardFailedAccessLogMessage(@NotNull final LogMessage m)
  {
    super(m);
