       ...
       extends LDAPSDKTestCase
{
  ...
  public void testToJSONControl()
          throws Exception
  {
    final PasswordValidationDetailsRequestControl c =
         new PasswordValidationDetailsRequestControl(false);
    ...
    PasswordValidationDetailsRequestControl decodedControl =
         PasswordValidationDetailsRequestControl.decodeJSONControl(
              controlObject, true);
