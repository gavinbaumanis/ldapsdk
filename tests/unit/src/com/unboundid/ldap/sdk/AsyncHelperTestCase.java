...
/**
 * This class provides a set of test cases for the {@code AsyncHelper} class.
 * <BR><BR>
 * Access to a Directory Server instance is required for complete processing.
 */
public class AsyncHelperTestCase
       extends LDAPSDKTestCase
{
  ...
  /**
   * Tests with a valid result message.
   * <BR><BR>
   * Access to a Directory Server instance is required for complete processing.
   *
   * @throws  Exception  If an unexpected problem occurs.
         ...
         throws Exception
  {
    ...
    AsyncHelper helper = new AsyncHelper(connection, OperationType.ADD, 1,
         asyncListener, null);

    helper.responseReceived(new LDAPResult(1, ResultCode.SUCCESS));
         ...
         throws Exception
  {
    ...
    AsyncHelper helper =
         new AsyncHelper(connection, OperationType.ADD, 1, asyncListener, null);
