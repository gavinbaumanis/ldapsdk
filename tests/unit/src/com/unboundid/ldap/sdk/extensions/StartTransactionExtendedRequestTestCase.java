 ...
 * StartTransactionExtendedRequest class.  It also provides coverage for
 * the StartTransactionExtendedResponse and
 * EndTransactionExtendedRequest classes, as well as testing
 * transactional functionality.
 */
public class StartTransactionExtendedRequestTestCase
       extends LDAPSDKTestCase
{
  ...
  public void testConstructor1()
         throws Exception
  {
    StartTransactionExtendedRequest r = new StartTransactionExtendedRequest();
    r = new StartTransactionExtendedRequest(r);
    r = r.duplicate();

    assertNotNull(r.getOID());
    assertEquals(r.getOID(), "1.3.6.1.1.21.1");
         ...
         throws Exception
  {
    ...
    StartTransactionExtendedRequest r =
  ...
  public void testConstructor3WithValue()
         throws Exception
  {
    new StartTransactionExtendedRequest(new ExtendedRequest("1.2.3.4",
