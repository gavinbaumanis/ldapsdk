 ...
 * JSON-formatted search entry access log message.
 * <BR>
 * <BLOCKQUOTE>
       ...
       implements SearchEntryAccessLogMessage
{
   ...
   *                        valid log message.
   */
  public JSONSearchEntryAccessLogMessage(@NotNull final JSONObject jsonObject)
         throws LogException
  {
    super(jsonObject);

    dn = getString(JSONFormattedAccessLogFields.SEARCH_RESULT_ENTRY_DN);
    attributesReturned = getStringSet(
         JSONFormattedAccessLogFields.SEARCH_RESULT_ENTRY_ATTRIBUTES);
