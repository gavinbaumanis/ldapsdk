 ...
 * JSON-formatted modify assurance completed access log message.
 * <BR>
 * <BLOCKQUOTE>
...
public final class JSONModifyAssuranceCompletedAccessLogMessage
       extends JSONModifyResultAccessLogMessage
       implements ModifyAssuranceCompletedAccessLogMessage
{
  ...
  /**
   * Creates a new JSON modify assurance completed access log message from the
   ...
   *                        valid log message.
   */
  public JSONModifyAssuranceCompletedAccessLogMessage(
