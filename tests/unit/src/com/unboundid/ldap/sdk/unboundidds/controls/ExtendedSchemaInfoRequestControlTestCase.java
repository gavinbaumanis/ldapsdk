       ...
       extends LDAPSDKTestCase
{
  ...
  public void testToJSONControl()
          throws Exception
  {
    final ExtendedSchemaInfoRequestControl c =
         new ExtendedSchemaInfoRequestControl(false);
    ...
    ExtendedSchemaInfoRequestControl decodedControl =
         ExtendedSchemaInfoRequestControl.decodeJSONControl(controlObject,
              true);
