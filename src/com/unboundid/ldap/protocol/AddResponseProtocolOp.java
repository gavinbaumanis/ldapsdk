       ...
       extends GenericResponseProtocolOp
{
   ...
   *                            any.
   */
  public AddResponseProtocolOp(final int resultCode,
   ...
   */
  public AddResponseProtocolOp(@NotNull final LDAPResult result)
  {
   ...
   *                         add response.
   */
  AddResponseProtocolOp(@NotNull final ASN1StreamReader reader)
