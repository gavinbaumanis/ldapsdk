 ...
 * {@code DeleteRequestAccessLogMessage} class.
 */
public class DeleteRequestAccessLogMessageTestCase
       extends LDAPSDKTestCase
{
         ...
         throws Exception
  {
    ...
    DeleteRequestAccessLogMessage m = new DeleteRequestAccessLogMessage(s);
    m = new DeleteRequestAccessLogMessage(m);
         ...
         throws Exception
  {
    ...
    SimpleDateFormat f = new SimpleDateFormat("'['dd/MMM/yyyy:HH:mm:ss Z']'");
    String s = f.format(d) + " DELETE REQUEST conn=1 op=2 msgID=3 " +
         ...
         throws Exception
  {
    ...
    String s = f.format(d) + " DELETE REQUEST " +
               ...
               "dn=\"dc=example,dc=com\" triggeredByConn=987 triggeredByOp=654";
