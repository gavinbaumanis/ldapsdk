...
/**
 * This class provides test coverage for the PersistMessages class.
 */
public class PersistMessagesTestCase
       extends LDAPSDKTestCase
{
  ...
  public void testMessageDefined(final PersistMessages m)
         throws Exception
  {
    assertNotNull(m);

    assertEquals(PersistMessages.valueOf(m.name()), m);
  ...
  {
    PersistMessages[] values = PersistMessages.values();
