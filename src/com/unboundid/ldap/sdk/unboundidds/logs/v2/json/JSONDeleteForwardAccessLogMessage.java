 ...
 * JSON-formatted delete forward access log message.
 * <BR>
 * <BLOCKQUOTE>
...
public class JSONDeleteForwardAccessLogMessage
       ...
       implements DeleteForwardAccessLogMessage
{
   ...
   */
  private static final long serialVersionUID = 8939288708113650863L;
  ...
  /**
   * Creates a new JSON delete forward access log message from the provided
   * JSON object.
   *
   ...
   *                        valid log message.
   */
  public JSONDeleteForwardAccessLogMessage(@NotNull final JSONObject jsonObject)
         throws LogException
  {
    super(jsonObject);
