...
public final class CompareForwardFailedAccessLogMessage
       extends CompareRequestAccessLogMessage
{
  ...
  /**
   * Creates a new compare forward failed access log message from the provided
   * message string.
   *
   * @param  s  The string to be parsed as a compare forward failed access log
   *            message.
   *
