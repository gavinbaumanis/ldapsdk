 ...
 * text-formatted modify request access log message.
 * <BR>
 * <BLOCKQUOTE>
...
public class TextFormattedModifyRequestAccessLogMessage
       extends TextFormattedRequestAccessLogMessage
       implements ModifyRequestAccessLogMessage
{
  /**
  ...
  /**
   * Creates a new text-formatted modify request access log message from the
   ...
   *                        log message.
   */
  public TextFormattedModifyRequestAccessLogMessage(
   ...
   * provided message.
   *
   * @param  logMessage  The log message to use to create this modify request
       ...
       @NotNull final TextFormattedLogMessage logMessage)
  {
    ...
    dn = getString(TextFormattedAccessLogFields.MODIFY_ENTRY_DN);
    attributeNames = getCommaDelimitedStringSet(
         TextFormattedAccessLogFields.MODIFY_ATTRIBUTES);
  }
