 ...
 * JSON-formatted modify forward access log message.
 * <BR>
 * <BLOCKQUOTE>
...
public class JSONModifyForwardAccessLogMessage
       ...
       implements ModifyForwardAccessLogMessage
{
   ...
   */
  private static final long serialVersionUID = -2941843174019315260L;
  ...
  /**
   * Creates a new JSON modify forward access log message from the provided
   * JSON object.
   *
   ...
   *                        valid log message.
   */
  public JSONModifyForwardAccessLogMessage(@NotNull final JSONObject jsonObject)
         throws LogException
  {
    super(jsonObject);
