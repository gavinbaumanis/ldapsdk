...
/**
 * This class provides a set of tests for the log syntax exception.
 */
public final class LogSyntaxExceptionTestCase
       extends LDAPSDKTestCase
{
  ...
  public void testWithoutCause()
         throws Exception
  {
    final LogSyntaxException e = new LogSyntaxException("foo");
  ...
  public void testWithNullCause()
         throws Exception
  {
    final LogSyntaxException e = new LogSyntaxException("bar", null);
         ...
         throws Exception
  {
    ...
    final LogSyntaxException e = new LogSyntaxException("baz", cause);
