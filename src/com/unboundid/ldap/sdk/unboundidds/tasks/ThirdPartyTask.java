 ...
 * <UL>
 *   <LI>The fully-qualified name of the Java class providing the logic for the
 *       third-party task.  This must be provided.</LI>
       ...
       extends Task
{
  ...
  /**
   * Creates a new uninitialized third-party task instance which should only
   ...
   *                        as the task ID.
   * @param  taskClassName  The fully-qualified name of the Java class providing
   *                        the logic for the task.  It must not be
   *                        {@code null}.
   ...
   *                                 providing the logic for the task.  It must
   *                                 not be {@code null}.
   ...
   *
   * @param  entry  The entry to use to create this third-party task.
   *
         ...
         throws TaskException
  {
    ...
    taskClassName = entry.getAttributeValue(ATTR_THIRD_PARTY_TASK_CLASS);
    if (taskClassName == null)
    {
      throw new TaskException(ERR_THIRD_PARTY_TASK_NO_CLASS.get(
           getTaskEntryDN()));
    }
    ...
    final String[] args =
         entry.getAttributeValues(ATTR_THIRD_PARTY_TASK_ARGUMENT);
  ...
  /**
   * Retrieves the fully-qualified name of the Java class providing the logic
  ...
  protected List<Attribute> getAdditionalAttributes()
  {
    ...
    {
      attrList.add(new Attribute(ATTR_THIRD_PARTY_TASK_ARGUMENT,
           taskArguments));
    }
