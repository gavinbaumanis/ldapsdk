 ...
 */
public class LDAPMessagesTestCase
       extends LDAPSDKTestCase
{
  ...
  public void testMessageDefined(final LDAPMessages m)
         throws Exception
  {
    assertNotNull(m);

    assertEquals(LDAPMessages.valueOf(m.name()), m);
  ...
  {
    LDAPMessages[] values = LDAPMessages.values();
