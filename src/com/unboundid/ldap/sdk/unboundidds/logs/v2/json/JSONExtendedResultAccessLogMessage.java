       ...
       implements ExtendedResultAccessLogMessage
{
   ...
   */
  private static final long serialVersionUID = 7621964612135990123L;
  ...
  /**
   * Creates a new JSON extended result access log message from the provided
   * JSON object.
   *
   ...
   *                        valid log message.
   */
  public JSONExtendedResultAccessLogMessage(
              @NotNull final JSONObject jsonObject)
         throws LogException
  {
    super(jsonObject);

    responseOID = getString(JSONFormattedAccessLogFields.EXTENDED_RESPONSE_OID);
    responseType =
         getString(JSONFormattedAccessLogFields.EXTENDED_RESPONSE_TYPE);
    clientConnectionPolicy = getString(
         JSONFormattedAccessLogFields.CLIENT_CONNECTION_POLICY);
