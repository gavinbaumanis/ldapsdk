...
/**
 * This class provides a set of test cases for the replace inter-server
 * certificate extended result.
 */
public final class ReplaceInterServerCertificateExtendedResultTestCase
     extends LDAPSDKTestCase
{
         ...
         throws Exception
  {
    ...
    ReplaceInterServerCertificateExtendedResult r =
         new ReplaceInterServerCertificateExtendedResult(2,
    ...
    r = new ReplaceInterServerCertificateExtendedResult(r);
         ...
         throws Exception
  {
    ...
    ReplaceInterServerCertificateExtendedResult r =
         new ReplaceInterServerCertificateExtendedResult(3,
  ...
  public void testDecodeResultWithoutOIDOrValue()
         throws Exception
  {
    final ReplaceInterServerCertificateExtendedResult r =
         new ReplaceInterServerCertificateExtendedResult(new ExtendedResult(4,
