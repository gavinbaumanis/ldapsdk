 ...
 * text-formatted add result access log message.
 * <BR>
 * <BLOCKQUOTE>
...
public class TextFormattedAddResultAccessLogMessage
       ...
       implements AddResultAccessLogMessage
{
   ...
   */
  private static final long serialVersionUID = 3304071083358480036L;
  ...
  /**
   * Creates a new text-formatted add result access log message from the
   ...
   *                        log message.
   */
  public TextFormattedAddResultAccessLogMessage(
   ...
   * provided message.
   *
   * @param  logMessage  The log message to use to create this add result access
       ...
       @NotNull final TextFormattedLogMessage logMessage)
  {
    ...
    undeleteFromDN =
         getString(TextFormattedAccessLogFields.ADD_UNDELETE_FROM_DN);
