 ...
 * extended result.
 */
public final class DeliverPasswordResetTokenExtendedResultTestCase
       extends LDAPSDKTestCase
{
  ...
  public void testSuccessResult()
         throws Exception
  {
    DeliverPasswordResetTokenExtendedResult r =
         new DeliverPasswordResetTokenExtendedResult(1, ResultCode.SUCCESS,
              null, null, null, "SMS", "123-456-7890",
              "Sent a password reset token via SMS to 123-456-7890");

    r = new DeliverPasswordResetTokenExtendedResult(r);
    ...
    assertEquals(r.getOID(), "1.3.6.1.4.1.30221.2.6.46");
         ...
         throws Exception
  {
    ...
    DeliverPasswordResetTokenExtendedResult r =
         new DeliverPasswordResetTokenExtendedResult(2,
  ...
  public void testDecodeValueNotSequence()
         throws Exception
  {
    new DeliverPasswordResetTokenExtendedResult(new ExtendedResult(1,
         ResultCode.SUCCESS, null, null, null, "1.3.6.1.4.1.30221.2.6.46",
