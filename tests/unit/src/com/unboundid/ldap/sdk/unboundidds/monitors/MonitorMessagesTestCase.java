...
/**
 * This class provides test coverage for the MonitorMessages class.
 */
public class MonitorMessagesTestCase
       extends LDAPSDKTestCase
{
  ...
  public void testMessageDefined(final MonitorMessages m)
         throws Exception
  {
    assertNotNull(m);

    assertEquals(MonitorMessages.valueOf(m.name()), m);
  ...
  {
    MonitorMessages[] values = MonitorMessages.values();
