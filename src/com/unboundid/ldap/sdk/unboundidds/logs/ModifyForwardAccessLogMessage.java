...
public final class ModifyForwardAccessLogMessage
       extends ModifyRequestAccessLogMessage
{
  ...
  /**
   * Creates a new modify forward access log message from the provided message
   * string.
   *
   * @param  s  The string to be parsed as a modify forward access log message.
   *
   * @throws  LogException  If the provided string cannot be parsed as a valid
   *                        log message.
   */
  public ModifyForwardAccessLogMessage(@NotNull final String s)
         throws LogException
  {
  ...
  /**
   * Creates a new modify forward access log message from the provided log
   * message.
   *
   * @param  m  The log message to be parsed as a modify forward access log
   *            message.
   */
  public ModifyForwardAccessLogMessage(@NotNull final LogMessage m)
  {
    super(m);
