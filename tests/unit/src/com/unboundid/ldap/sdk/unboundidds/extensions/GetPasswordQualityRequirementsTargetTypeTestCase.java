       ...
       extends LDAPSDKTestCase
{
  ...
  public void testForNameAutomated()
         throws Exception
  {
    for (final GetPasswordQualityRequirementsTargetType value :
         GetPasswordQualityRequirementsTargetType.values())
    {
      for (final String name : getNames(value.name()))
      {
        assertNotNull(GetPasswordQualityRequirementsTargetType.forName(name));
        assertEquals(GetPasswordQualityRequirementsTargetType.forName(name),
             value);
      }
    }

    assertNull(GetPasswordQualityRequirementsTargetType.forName(
         "some undefined name"));
  }
