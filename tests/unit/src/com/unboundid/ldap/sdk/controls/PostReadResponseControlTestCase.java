       ...
       extends LDAPSDKTestCase
{
         ...
         throws Exception
  {
    ...
    PostReadResponseControl c =
         new PostReadResponseControl().decodeControl("1.3.6.1.1.13.2", false,
          ...
          throws Exception
  {
    ...
    final PostReadResponseControl c = new PostReadResponseControl(e);
    ...
    PostReadResponseControl decodedControl =
         PostReadResponseControl.decodeJSONControl(controlObject, true);
