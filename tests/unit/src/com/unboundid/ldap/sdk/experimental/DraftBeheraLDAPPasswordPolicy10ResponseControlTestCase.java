/*
 * Copyright 2007-2026 Ping Identity Corporation
 * All Rights Reserved.
 */
/*
 * Copyright 2007-2026 Ping Identity Corporation
 ...
 */
/*
 * Copyright (C) 2007-2026 Ping Identity Corporation
 *
 ...
 * DraftBeheraLDAPPasswordPolicy10ResponseControl class.
 */
public class DraftBeheraLDAPPasswordPolicy10ResponseControlTestCase
       extends LDAPSDKTestCase
{
  ...
  {
    DraftBeheraLDAPPasswordPolicy10ResponseControl c =
         new DraftBeheraLDAPPasswordPolicy10ResponseControl(
              DraftBeheraLDAPPasswordPolicy10WarningType.GRACE_LOGINS_REMAINING,
              2, DraftBeheraLDAPPasswordPolicy10ErrorType.PASSWORD_EXPIRED);
  ...
  {
    DraftBeheraLDAPPasswordPolicy10ResponseControl c =
         new DraftBeheraLDAPPasswordPolicy10ResponseControl(null, -1,
  ...
  {
    DraftBeheraLDAPPasswordPolicy10ResponseControl c =
         new DraftBeheraLDAPPasswordPolicy10ResponseControl(null, -1, null);
  ...
  public void testConstructor3OnlyError()
  {
    DraftBeheraLDAPPasswordPolicy10ResponseControl c =
         new DraftBeheraLDAPPasswordPolicy10ResponseControl(null, -1,
              DraftBeheraLDAPPasswordPolicy10ErrorType.ACCOUNT_LOCKED, false);
         ...
         throws Exception
  {
    ...
    DraftBeheraLDAPPasswordPolicy10ResponseControl c =
         new DraftBeheraLDAPPasswordPolicy10ResponseControl().decodeControl(
         ...
         throws Exception
  {
    ...
    final DraftBeheraLDAPPasswordPolicy10ResponseControl c =
         DraftBeheraLDAPPasswordPolicy10ResponseControl.get(r);
    assertNull(c);
  }
  ...
  public void testGetValidGenericType()
         throws Exception
  {
    final Control tmp = new DraftBeheraLDAPPasswordPolicy10ResponseControl(
         DraftBeheraLDAPPasswordPolicy10WarningType.TIME_BEFORE_EXPIRATION,
         1234, null);
