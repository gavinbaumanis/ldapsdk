...
/**
 * This class provides test coverage for the JSONLogMessages class.
 */
public class JSONLogMessagesTestCase
       extends LDAPSDKTestCase
{
  ...
  public void testMessageDefined(final JSONLogMessages m)
         throws Exception
  {
    assertNotNull(m);

    assertEquals(JSONLogMessages.valueOf(m.name()), m);
   ...
   */
  @Test(dataProvider = "messageKeys")
  public void testMessageGetWithArgsWithoutException(final JSONLogMessages m)
         throws Exception
  {
  ...
  {
    JSONLogMessages[] values = JSONLogMessages.values();
