       ...
       extends Control
{
  ...
  /**
   * Retrieves a representation of this get recent login history request control
   ...
   *     identifier for this control.  For the get recent login history request
   *     control, the OID is "1.3.6.1.4.1.30221.2.5.61".
   *   </LI>
   *   <LI>
  ...
  public JSONObject toJSONControl()
  {
    return new JSONObject(
         ...
         new JSONField(JSONControlDecodeHelper.JSON_FIELD_CONTROL_NAME,
              INFO_CONTROL_NAME_GET_RECENT_LOGIN_HISTORY_REQUEST.get()),
   ...
   * recent login history request control.
   *
   ...
   *
   * @return  The get recent login history request control that was decoded from
   *          the provided JSON object.
   *
   * @throws  LDAPException  If the provided JSON object cannot be parsed as a
   *                         valid get recent login history request control.
   */
  @NotNull()
  public static GetRecentLoginHistoryRequestControl decodeJSONControl(
         ...
         throws LDAPException
  {
    ...
    return new GetRecentLoginHistoryRequestControl(
