...
/**
 * This class provides test coverage for the LDIFMessages class.
 */
public class LDIFMessagesTestCase
       extends LDIFTestCase
{
  ...
  public void testMessageDefined(final LDIFMessages m)
         throws Exception
  {
    assertNotNull(m);
  ...
  {
    LDIFMessages[] values = LDIFMessages.values();
