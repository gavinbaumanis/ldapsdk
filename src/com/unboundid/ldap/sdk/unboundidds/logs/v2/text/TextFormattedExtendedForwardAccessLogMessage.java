 ...
 * text-formatted extended forward access log message.
 * <BR>
 * <BLOCKQUOTE>
...
public class TextFormattedExtendedForwardAccessLogMessage
       ...
       implements ExtendedForwardAccessLogMessage
{
   ...
   */
  private static final long serialVersionUID = -3551286281578035269L;
  ...
  /**
   * Creates a new text-formatted extended forward access log message from the
   ...
   *                        log message.
   */
  public TextFormattedExtendedForwardAccessLogMessage(
