       ...
       extends Control
{
  ...
  /**
   * Retrieves a representation of this get backend set ID request control as a
   ...
   *     identifier for this control.  For the get backend set ID request
   *     control, the OID is "1.3.6.1.4.1.30221.2.5.33".
   *   </LI>
   *   <LI>
  ...
  public JSONObject toJSONControl()
  {
    return new JSONObject(
         ...
         new JSONField(JSONControlDecodeHelper.JSON_FIELD_CONTROL_NAME,
              INFO_CONTROL_NAME_GET_BACKEND_SET_ID_REQUEST.get()),
   ...
   *
   * @return  The get backend set ID request control that was decoded from
   *          the provided JSON object.
   *
   * @throws  LDAPException  If the provided JSON object cannot be parsed as a
   *                         valid get backend set ID request control.
   */
  @NotNull()
  public static GetBackendSetIDRequestControl decodeJSONControl(
         ...
         throws LDAPException
  {
    ...
    return new GetBackendSetIDRequestControl(jsonControl.getCriticality());
  }
