       ...
       extends LDAPSDKTestCase
{
  ...
  public void testToJSONControl()
          throws Exception
  {
    final PurgePasswordRequestControl c =
         new PurgePasswordRequestControl(false);
    ...
    PurgePasswordRequestControl decodedControl =
         PurgePasswordRequestControl.decodeJSONControl(controlObject,
              true);
