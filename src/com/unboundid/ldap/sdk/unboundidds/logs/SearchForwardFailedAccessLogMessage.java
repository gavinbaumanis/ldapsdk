...
public final class SearchForwardFailedAccessLogMessage
       extends SearchRequestAccessLogMessage
{
  ...
  /**
   * Creates a new search forward failed access log message from the provided
   * message string.
   *
   * @param  s  The string to be parsed as a search forward failed access log
   *            message.
   *
   * @throws  LogException  If the provided string cannot be parsed as a valid
   *                        log message.
   */
  public SearchForwardFailedAccessLogMessage(@NotNull final String s)
         throws LogException
  {
   ...
   * log message.
   *
   * @param  m  The log message to be parsed as a search forward failed access
   *            log message.
   */
  public SearchForwardFailedAccessLogMessage(@NotNull final LogMessage m)
  {
    super(m);
