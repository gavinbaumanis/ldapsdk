 ...
 */
public class ExtOpMessagesTestCase
       extends LDAPSDKTestCase
{
  ...
  public void testMessageDefined(final ExtOpMessages m)
         throws Exception
  {
    assertNotNull(m);

    assertEquals(ExtOpMessages.valueOf(m.name()), m);
  ...
  {
    ExtOpMessages[] values = ExtOpMessages.values();
