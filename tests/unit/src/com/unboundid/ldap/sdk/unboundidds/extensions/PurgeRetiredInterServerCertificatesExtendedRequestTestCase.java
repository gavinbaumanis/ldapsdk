 ...
 * {@code PurgeRetiredInterServerCertificatesExtendedRequest} class.
 */
public final class PurgeRetiredInterServerCertificatesExtendedRequestTestCase
       extends LDAPSDKTestCase
{
  ...
  public void testRequestWithoutControls()
         throws Exception
  {
    PurgeRetiredInterServerCertificatesExtendedRequest r =
         new PurgeRetiredInterServerCertificatesExtendedRequest();

    r = new PurgeRetiredInterServerCertificatesExtendedRequest(r);
         ...
         throws Exception
  {
    ...
    {
      new PurgeRetiredInterServerCertificatesExtendedRequest(
           new ExtendedRequest("1.3.6.1.4.1.30221.2.6.71",
                new ASN1OctetString("unexpected")));
