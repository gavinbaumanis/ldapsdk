 ...
 * {@code ModifyResultAccessLogMessage} class.
 */
public class ModifyResultAccessLogMessageTestCase
       extends LDAPSDKTestCase
{
         ...
         throws Exception
  {
    ...
    ModifyResultAccessLogMessage m = new ModifyResultAccessLogMessage(s);
    m = new ModifyResultAccessLogMessage(m);
         ...
         throws Exception
  {
    ...
    SimpleDateFormat f = new SimpleDateFormat("'['dd/MMM/yyyy:HH:mm:ss Z']'");
    String s = f.format(d) + " MODIFY RESULT conn=1 op=2 msgID=3 " +
