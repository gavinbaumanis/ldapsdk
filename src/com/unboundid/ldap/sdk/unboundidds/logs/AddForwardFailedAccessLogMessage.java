...
public final class AddForwardFailedAccessLogMessage
       extends AddRequestAccessLogMessage
{
  ...
  /**
   * Creates a new add forward failed access log message from the provided
   * message string.
   *
   * @param  s  The string to be parsed as an add forward failed access log
   *            message.
   *
   * @throws  LogException  If the provided string cannot be parsed as a valid
   *                        log message.
   */
  public AddForwardFailedAccessLogMessage(@NotNull final String s)
         throws LogException
  {
  ...
  /**
   * Creates a new add forward failed access log message from the provided log
   * message.
   *
   * @param  m  The log message to be parsed as an add forward failed access log
   *            message.
   */
  public AddForwardFailedAccessLogMessage(@NotNull final LogMessage m)
  {
    super(m);
