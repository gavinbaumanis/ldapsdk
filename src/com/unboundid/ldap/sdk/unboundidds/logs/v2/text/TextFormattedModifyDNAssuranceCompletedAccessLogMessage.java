 ...
 * text-formatted modify DN assurance completed access log message.
 * <BR>
 * <BLOCKQUOTE>
...
public final class TextFormattedModifyDNAssuranceCompletedAccessLogMessage
       extends TextFormattedModifyDNResultAccessLogMessage
       implements ModifyDNAssuranceCompletedAccessLogMessage
{
  /**
   * The serial version UID for this serializable class.
   */
  private static final long serialVersionUID = -8115598157203225547L;
  ...
  /**
   * Creates a new text-formatted modify DN assurance completed access log
   * message from the provided message string.
   *
   ...
   *                        log message.
   */
  public TextFormattedModifyDNAssuranceCompletedAccessLogMessage(
  ...
  /**
   * Creates a new text-formatted modify DN assurance completed access log
   * message from the provided message.
   *
