...
/**
 * This class provides test coverage for the TextLogMessages class.
 */
public class TextLogMessagesTestCase
       extends LDAPSDKTestCase
{
  ...
  public void testMessageDefined(final TextLogMessages m)
         throws Exception
  {
    assertNotNull(m);

    assertEquals(TextLogMessages.valueOf(m.name()), m);
   ...
   */
  @Test(dataProvider = "messageKeys")
  public void testMessageGetWithArgsWithoutException(final TextLogMessages m)
         throws Exception
  {
  ...
  {
    TextLogMessages[] values = TextLogMessages.values();
