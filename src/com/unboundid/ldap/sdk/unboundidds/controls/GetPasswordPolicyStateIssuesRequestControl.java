       ...
       extends Control
{
  ...
  /**
   * Retrieves a representation of this get password policy state issues request
   ...
   *     request control, the OID is "1.3.6.1.4.1.30221.2.5.46".
   *   </LI>
   *   <LI>
  ...
  public JSONObject toJSONControl()
  {
    return new JSONObject(
         ...
         new JSONField(JSONControlDecodeHelper.JSON_FIELD_CONTROL_NAME,
              INFO_CONTROL_NAME_GET_PWP_STATE_ISSUES_REQUEST.get()),
   ...
   * password policy state issues request control.
   *
   ...
   *
   * @return  The get password policy state issues request control that was
   *          decoded from the provided JSON object.
   *
   * @throws  LDAPException  If the provided JSON object cannot be parsed as a
   *                         valid get password policy state issues request
   *                         control.
   */
  @NotNull()
  public static GetPasswordPolicyStateIssuesRequestControl decodeJSONControl(
         ...
         throws LDAPException
  {
    ...
    return new GetPasswordPolicyStateIssuesRequestControl(
