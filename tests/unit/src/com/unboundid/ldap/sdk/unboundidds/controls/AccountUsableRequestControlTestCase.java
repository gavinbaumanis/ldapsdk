       ...
       extends LDAPSDKTestCase
{
  ...
  public void testToJSONControl()
          throws Exception
  {
    final AccountUsableRequestControl c =
         new AccountUsableRequestControl(false);
    ...
    AccountUsableRequestControl decodedControl =
         AccountUsableRequestControl.decodeJSONControl(controlObject, true);
