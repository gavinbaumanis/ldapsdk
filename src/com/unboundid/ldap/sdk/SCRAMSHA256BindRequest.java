       ...
       extends SCRAMBindRequest
{
   ...
   */
  @NotNull public static final String SCRAM_SHA_256_MECHANISM_NAME =
       "SCRAM-SHA-256";
   ...
   */
  public SCRAMSHA256BindRequest(@NotNull final String username,
  ...
  {
    return SCRAM_SHA_256_MECHANISM_NAME;
  }
  ...
  @Override()
  @NotNull()
  public SCRAMSHA256BindRequest getRebindRequest(@NotNull final String host,
                                                 final int port)
  {
    return duplicate();
  }
