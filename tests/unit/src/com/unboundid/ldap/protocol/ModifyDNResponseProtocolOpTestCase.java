 ...
 * {@code ModifyDNResponseProtocolOp} class.
 */
public class ModifyDNResponseProtocolOpTestCase
       extends LDAPSDKTestCase
{
  /**
   * Provides test coverage for the modify DN response protocol op for a success
   * response.
   *
   * @throws  Exception  If an unexpected problem occurs.
   */
  @Test()
  public void testModifyDNResponseProtocolOpSuccess()
         throws Exception
  {
   ...
   */
  @Test()
  public void testModifyDNResponseProtocolOpFailure()
         throws Exception
  {
    ...
    ModifyDNResponseProtocolOp op = new ModifyDNResponseProtocolOp(32,
  ...
  /**
   * Tests the behavior when trying to read a malformed modify DN response.
   *
   * @throws  Exception  If an unexpected problem occurs.
   */
  @Test(expectedExceptions = { LDAPException.class })
  public void testReadMalformedModifyDNResponse()
         throws Exception
  {
    byte[] opBytes = { 0x6D, 0x00 };
    ByteArrayInputStream inputStream = new ByteArrayInputStream(opBytes);
    ASN1StreamReader reader = new ASN1StreamReader(inputStream);
    new ModifyDNResponseProtocolOp(reader);
  }



  /**
   * Tests the behavior when trying to decode a malformed modify DN response.
   *
   * @throws  Exception  If an unexpected problem occurs.
   */
  @Test(expectedExceptions = { LDAPException.class })
  public void testDecodeMalformedModifyDNResponse()
         throws Exception
  {
    ModifyDNResponseProtocolOp.decodeProtocolOp(
         new ASN1Element(LDAPMessage.PROTOCOL_OP_TYPE_MODIFY_DN_RESPONSE));
  }
}
