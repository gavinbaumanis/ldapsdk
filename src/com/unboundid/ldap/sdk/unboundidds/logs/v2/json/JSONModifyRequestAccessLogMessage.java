 ...
 * JSON-formatted modify request access log message.
 * <BR>
 * <BLOCKQUOTE>
...
public class JSONModifyRequestAccessLogMessage
       ...
       implements ModifyRequestAccessLogMessage
{
   ...
   */
  private static final long serialVersionUID = -5294451900677670168L;
  ...
  /**
   * Creates a new JSON modify request access log message from the provided
   * JSON object.
   *
   ...
   *                        valid log message.
   */
  public JSONModifyRequestAccessLogMessage(
              @NotNull final JSONObject jsonObject)
         throws LogException
  {
    super(jsonObject);

    dn = getString(JSONFormattedAccessLogFields.MODIFY_ENTRY_DN);
    attributeNames =
         getStringSet(JSONFormattedAccessLogFields.MODIFY_ATTRIBUTES);
  }
