...
/**
 * This class provides test coverage for the ProtocolMessages class.
 */
public class ProtocolMessagesTestCase
       extends LDAPSDKTestCase
{
  ...
  public void testMessageDefined(final ProtocolMessages m)
         throws Exception
  {
    assertNotNull(m);

    assertEquals(ProtocolMessages.valueOf(m.name()), m);
  ...
  {
    ProtocolMessages[] values = ProtocolMessages.values();
