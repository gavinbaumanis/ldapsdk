...
public final class ModifyDNForwardAccessLogMessage
       extends ModifyDNRequestAccessLogMessage
{
  ...
  /**
   * Creates a new modify DN forward access log message from the provided
   * message string.
   *
   * @param  s  The string to be parsed as a modify DN forward access log
   *            message.
   *
  ...
  /**
   * Creates a new modify DN forward access log message from the provided log
   * message.
   *
