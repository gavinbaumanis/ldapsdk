 ...
 * "out-of-the-box" ForgeRock DS-specific response controls supported by this
 * SDK are registered so that they can be properly instantiated when received in
 * a response from the directory server.
 */
@InternalUseOnly()
...
public final class ControlHelper
{
  ...
  /**
   * Registers all "out-of-the-box" response ForgeRock DS-specific controls
  ...
  public static void registerDefaultResponseControls()
  {
    ...
    Control.registerDecodeableControl("1.3.6.1.4.1.42.2.27.9.5.9",
         packageNameDot + "ChangeSequenceNumberResponseControl");
  }
}
