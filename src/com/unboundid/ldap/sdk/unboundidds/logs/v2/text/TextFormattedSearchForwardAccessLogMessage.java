 ...
 * text-formatted search forward access log message.
 * <BR>
 * <BLOCKQUOTE>
...
public class TextFormattedSearchForwardAccessLogMessage
       ...
       implements SearchForwardAccessLogMessage
{
   ...
   */
  private static final long serialVersionUID = 14398890946541072L;
  ...
  /**
   * Creates a new text-formatted search forward access log message from the
   ...
   *                        log message.
   */
  public TextFormattedSearchForwardAccessLogMessage(
