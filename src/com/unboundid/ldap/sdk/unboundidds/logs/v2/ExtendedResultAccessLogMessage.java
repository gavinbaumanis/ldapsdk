...
public interface ExtendedResultAccessLogMessage
               ...
               ExtendedForwardAccessLogMessage
{
  ...
  /**
   * Retrieves the type of extended response being returned.  This is
   * generally a human-readable name for the operation.
   *
   * @return  The type of extended response, or {@code null} if it is not
   *          included in the log message.
   */
  @Nullable()
