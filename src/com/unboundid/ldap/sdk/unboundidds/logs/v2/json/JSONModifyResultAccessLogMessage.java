 ...
 * JSON-formatted modify result access log message.
 * <BR>
 * <BLOCKQUOTE>
...
public class JSONModifyResultAccessLogMessage
       extends JSONModifyRequestAccessLogMessage
       implements ModifyResultAccessLogMessage
{
  /**
   * The serial version UID for this serializable class.
   */
  private static final long serialVersionUID = 756591782437114972L;



  // Indicates whether this operation is a change to a soft-deleted entry.
  ...
  /**
   * Creates a new JSON modify result access log message from the provided JSON
   * object.
   *
   ...
   *                        valid log message.
   */
  public JSONModifyResultAccessLogMessage(@NotNull final JSONObject jsonObject)
         throws LogException
  {
    super(jsonObject);

    changeToSoftDeletedEntry = getBooleanNoThrow(
         JSONFormattedAccessLogFields.CHANGE_TO_SOFT_DELETED_ENTRY);
