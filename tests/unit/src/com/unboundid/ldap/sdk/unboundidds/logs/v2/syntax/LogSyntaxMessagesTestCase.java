...
/**
 * This class provides test coverage for the LogMessages class.
 */
public class LogSyntaxMessagesTestCase
       extends LDAPSDKTestCase
{
  ...
  public void testMessageDefined(final LogSyntaxMessages m)
         throws Exception
  {
    assertNotNull(m);

    assertEquals(LogSyntaxMessages.valueOf(m.name()), m);
   ...
   */
  @Test(dataProvider = "messageKeys")
  public void testMessageGetWithArgsWithoutException(final LogSyntaxMessages m)
         throws Exception
  {
  ...
  {
    LogSyntaxMessages[] values = LogSyntaxMessages.values();
