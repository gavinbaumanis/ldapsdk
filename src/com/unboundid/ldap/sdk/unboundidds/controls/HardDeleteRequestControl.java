       ...
       extends Control
{
  ...
  public JSONObject toJSONControl()
  {
    return new JSONObject(
         ...
         new JSONField(JSONControlDecodeHelper.JSON_FIELD_CONTROL_NAME,
              INFO_CONTROL_NAME_HARD_DELETE_REQUEST.get()),
   ...
   *
   * @return  The hard delete request control that was decoded from the provided
   *          JSON object.
   *
   ...
   */
  @NotNull()
  public static HardDeleteRequestControl decodeJSONControl(
         ...
         throws LDAPException
  {
    ...
    return new HardDeleteRequestControl(jsonControl.getCriticality());
  }
