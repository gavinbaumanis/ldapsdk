 ...
 * text-formatted modify result access log message.
 * <BR>
 * <BLOCKQUOTE>
...
public class TextFormattedModifyResultAccessLogMessage
       ...
       implements ModifyResultAccessLogMessage
{
   ...
   */
  private static final long serialVersionUID = 579526634550926224L;
  ...
  /**
   * Creates a new text-formatted modify result access log message from the
   ...
   *                        log message.
   */
  public TextFormattedModifyResultAccessLogMessage(
   ...
   * provided message.
   *
   * @param  logMessage  The log message to use to create this modify result
