 ...
 */
/*
 * Copyright (C) 2016-2026 Ping Identity Corporation
 *
...
/**
 * This class provides test coverage for the TransformationMessages class.
 */
public class TransformationMessagesTestCase
       extends LDAPSDKTestCase
{
  ...
  public void testMessageDefined(final TransformationMessages m)
         throws Exception
  {
    assertNotNull(m);

    assertEquals(TransformationMessages.valueOf(m.name()), m);
  ...
  {
    TransformationMessages[] values = TransformationMessages.values();
