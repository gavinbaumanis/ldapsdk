...
/**
 * This class provides test coverage for the CertMessages class.
 */
public class CertMessagesTestCase
       extends LDAPSDKTestCase
{
  ...
  public void testMessageDefined(final CertMessages m)
         throws Exception
  {
    assertNotNull(m);

    assertEquals(CertMessages.valueOf(m.name()), m);
  ...
  {
    final CertMessages[] values = CertMessages.values();
    final Object[][] returnArray = new Object[values.length][1];
