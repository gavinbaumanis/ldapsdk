 ...
 */
public final class ValuesOnlyLDAPResultWriterTestCase
       extends LDAPSDKTestCase
{
  ...
  public void testNullOutputStream()
         throws Exception
  {
    final ValuesOnlyLDAPResultWriter writer =
         new ValuesOnlyLDAPResultWriter(NullOutputStream.getInstance());
