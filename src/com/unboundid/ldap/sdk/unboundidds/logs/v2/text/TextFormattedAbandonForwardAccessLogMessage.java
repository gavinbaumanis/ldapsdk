 ...
 * text-formatted abandon forward access log message.
 * <BR>
 * <BLOCKQUOTE>
...
public class TextFormattedAbandonForwardAccessLogMessage
       extends TextFormattedAbandonRequestAccessLogMessage
       implements AbandonForwardAccessLogMessage
{
  /**
  ...
  /**
   * Creates a new text-formatted abandon forward access log message from the
   ...
   *                        log message.
   */
  public TextFormattedAbandonForwardAccessLogMessage(
