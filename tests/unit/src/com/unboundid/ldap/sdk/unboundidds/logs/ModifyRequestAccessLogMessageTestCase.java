 ...
 * {@code ModifyRequestAccessLogMessage} class.
 */
public class ModifyRequestAccessLogMessageTestCase
       extends LDAPSDKTestCase
{
         ...
         throws Exception
  {
    ...
    ModifyRequestAccessLogMessage m = new ModifyRequestAccessLogMessage(s);
    m = new ModifyRequestAccessLogMessage(m);
         ...
         throws Exception
  {
    ...
    SimpleDateFormat f = new SimpleDateFormat("'['dd/MMM/yyyy:HH:mm:ss Z']'");
    String s = f.format(d) + " MODIFY REQUEST conn=1 op=2 msgID=3 " +
         ...
         throws Exception
  {
    ...
    String s = f.format(d) + " MODIFY REQUEST " +
               ...
               "dn=\"dc=example,dc=com\" attrs=\"description,o\" " +
    ...
    assertTrue(m.getAttributeNames().contains("description"));
    assertTrue(m.getAttributeNames().contains("o"));
