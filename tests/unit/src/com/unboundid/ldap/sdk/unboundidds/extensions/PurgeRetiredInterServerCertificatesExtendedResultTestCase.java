...
/**
 * This class provides a set of test cases for the purge retired inter-server
 * certificates extended result.
 */
public final class PurgeRetiredInterServerCertificatesExtendedResultTestCase
     extends LDAPSDKTestCase
{
         ...
         throws Exception
  {
    ...
    PurgeRetiredInterServerCertificatesExtendedResult r =
         new PurgeRetiredInterServerCertificatesExtendedResult(2,
    ...
    r = new PurgeRetiredInterServerCertificatesExtendedResult(r);
    ...
    assertEquals(r.getOID(), "1.3.6.1.4.1.30221.2.6.71");
         ...
         throws Exception
  {
    ...
    PurgeRetiredInterServerCertificatesExtendedResult r =
         new PurgeRetiredInterServerCertificatesExtendedResult(3,
  ...
  public void testDecodeResultWithoutOIDOrValue()
         throws Exception
  {
    final PurgeRetiredInterServerCertificatesExtendedResult r =
         new PurgeRetiredInterServerCertificatesExtendedResult(
              new ExtendedResult(4, ResultCode.UNWILLING_TO_PERFORM,
                   "Unrecognized operation", null, null, null, null, null));
         ...
         throws Exception
  {
    try
    {
      new PurgeRetiredInterServerCertificatesExtendedResult(new ExtendedResult(
           4, ResultCode.UNWILLING_TO_PERFORM, "Unrecognized operation", null,
           null, "1.3.6.1.4.1.30221.2.6.71",
