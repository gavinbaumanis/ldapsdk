 ...
 * {@code ModifyForwardFailedAccessLogMessage} class.
 */
public class ModifyForwardFailedAccessLogMessageTestCase
       extends LDAPSDKTestCase
{
         ...
         throws Exception
  {
    ...
    ModifyForwardFailedAccessLogMessage m =
         new ModifyForwardFailedAccessLogMessage(s);
    m = new ModifyForwardFailedAccessLogMessage(m);
         ...
         throws Exception
  {
    ...
    SimpleDateFormat f = new SimpleDateFormat("'['dd/MMM/yyyy:HH:mm:ss Z']'");
    String s = f.format(d) + " MODIFY FORWARD-FAILED conn=1 op=2 msgID=3 " +
