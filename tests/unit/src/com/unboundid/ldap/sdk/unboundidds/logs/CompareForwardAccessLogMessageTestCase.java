 ...
 * {@code CompareForwardAccessLogMessage} class.
 */
public class CompareForwardAccessLogMessageTestCase
       extends LDAPSDKTestCase
{
         ...
         throws Exception
  {
    ...
    CompareForwardAccessLogMessage m = new CompareForwardAccessLogMessage(s);
    m = new CompareForwardAccessLogMessage(m);
         ...
         throws Exception
  {
    ...
    SimpleDateFormat f = new SimpleDateFormat("'['dd/MMM/yyyy:HH:mm:ss Z']'");
    String s = f.format(d) + " COMPARE FORWARD conn=1 op=2 msgID=3 " +
