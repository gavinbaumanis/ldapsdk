...
/**
 * This class provides test coverage for the TaskMessages class.
 */
public class TaskMessagesTestCase
       extends LDAPSDKTestCase
{
  ...
  public void testMessageDefined(final TaskMessages m)
         throws Exception
  {
    assertNotNull(m);

    assertEquals(TaskMessages.valueOf(m.name()), m);
  ...
  {
    TaskMessages[] values = TaskMessages.values();
