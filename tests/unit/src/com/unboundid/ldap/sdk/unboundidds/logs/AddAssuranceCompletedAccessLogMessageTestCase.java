/*
 * Copyright 2013-2026 Ping Identity Corporation
 * All Rights Reserved.
 */
/*
 * Copyright 2013-2026 Ping Identity Corporation
 ...
 */
/*
 * Copyright (C) 2013-2026 Ping Identity Corporation
 *
 ...
 * {@code AddAssuranceCompletedAccessLogMessage} class.
 */
public class AddAssuranceCompletedAccessLogMessageTestCase
       extends LDAPSDKTestCase
{
         ...
         throws Exception
  {
    ...
    AddAssuranceCompletedAccessLogMessage m =
         new AddAssuranceCompletedAccessLogMessage(s);
    m = new AddAssuranceCompletedAccessLogMessage(m);
         ...
         throws Exception
  {
    ...
    SimpleDateFormat f = new SimpleDateFormat("'['dd/MMM/yyyy:HH:mm:ss Z']'");
    String s = f.format(d) + " ADD ASSURANCE-COMPLETE conn=1 op=2 msgID=3 " +
