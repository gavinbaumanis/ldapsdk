 ...
 * {@code AddForwardFailedAccessLogMessage} class.
 */
public class AddForwardFailedAccessLogMessageTestCase
       extends LDAPSDKTestCase
{
         ...
         throws Exception
  {
    ...
    AddForwardFailedAccessLogMessage m =
         new AddForwardFailedAccessLogMessage(s);
    m = new AddForwardFailedAccessLogMessage(m);
         ...
         throws Exception
  {
    ...
    SimpleDateFormat f = new SimpleDateFormat("'['dd/MMM/yyyy:HH:mm:ss Z']'");
    String s = f.format(d) + " ADD FORWARD-FAILED conn=1 op=2 msgID=3 " +
