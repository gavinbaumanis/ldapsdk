 ...
 * handler that formats messages as tab-delimited text.
 */
public final class LDAPCompareTabDelimitedOutputHandlerTestCase
       extends LDAPSDKTestCase
{
         ...
         throws Exception
  {
    ...
    final LDAPCompareTabDelimitedOutputHandler outputHandler =
         new LDAPCompareTabDelimitedOutputHandler();
