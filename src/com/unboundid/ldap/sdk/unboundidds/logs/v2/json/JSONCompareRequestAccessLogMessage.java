 ...
 * JSON-formatted compare request access log message.
 * <BR>
 * <BLOCKQUOTE>
...
public class JSONCompareRequestAccessLogMessage
       ...
       implements CompareRequestAccessLogMessage
{
  ...
  /**
   * Creates a new JSON compare request access log message from the provided
   * JSON object.
   *
   ...
   *                        valid log message.
   */
  public JSONCompareRequestAccessLogMessage(
              @NotNull final JSONObject jsonObject)
         throws LogException
  {
    super(jsonObject);

    dn = getString(JSONFormattedAccessLogFields.COMPARE_ENTRY_DN);
    attributeName =
         getString(JSONFormattedAccessLogFields.COMPARE_ATTRIBUTE_NAME);
  }
