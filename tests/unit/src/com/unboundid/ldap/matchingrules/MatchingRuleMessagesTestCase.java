...
/**
 * This class provides test coverage for the MatchingRuleMessages class.
 */
public class MatchingRuleMessagesTestCase
       extends MatchingRuleTestCase
{
  ...
  public void testMessageDefined(final MatchingRuleMessages m)
         throws Exception
  {
    assertNotNull(m);

    assertEquals(MatchingRuleMessages.valueOf(m.name()), m);
  ...
  {
    MatchingRuleMessages[] values = MatchingRuleMessages.values();
