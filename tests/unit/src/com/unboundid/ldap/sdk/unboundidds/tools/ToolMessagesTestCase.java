...
/**
 * This class provides test coverage for the ToolMessages class.
 */
public class ToolMessagesTestCase
       extends LDAPSDKTestCase
{
  ...
  public void testMessageDefined(final ToolMessages m)
         throws Exception
  {
    assertNotNull(m);

    assertEquals(ToolMessages.valueOf(m.name()), m);
  ...
  {
    ToolMessages[] values = ToolMessages.values();
