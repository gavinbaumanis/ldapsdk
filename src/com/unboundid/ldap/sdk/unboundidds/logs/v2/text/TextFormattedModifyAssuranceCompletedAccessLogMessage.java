 ...
 * text-formatted modify assurance completed access log message.
 * <BR>
 * <BLOCKQUOTE>
...
public final class TextFormattedModifyAssuranceCompletedAccessLogMessage
       extends TextFormattedModifyResultAccessLogMessage
       implements ModifyAssuranceCompletedAccessLogMessage
{
  /**
   * The serial version UID for this serializable class.
   */
  private static final long serialVersionUID = 144196154283219976L;
  ...
  /**
   * Creates a new text-formatted modify assurance completed access log message
   ...
   *                        log message.
   */
  public TextFormattedModifyAssuranceCompletedAccessLogMessage(
   ...
   *
   * @param  logMessage  The log message to use to create this modify assurance
