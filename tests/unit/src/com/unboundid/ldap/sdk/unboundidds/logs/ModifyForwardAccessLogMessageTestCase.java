 ...
 * {@code ModifyForwardAccessLogMessage} class.
 */
public class ModifyForwardAccessLogMessageTestCase
       extends LDAPSDKTestCase
{
         ...
         throws Exception
  {
    ...
    ModifyForwardAccessLogMessage m = new ModifyForwardAccessLogMessage(s);
    m = new ModifyForwardAccessLogMessage(m);
         ...
         throws Exception
  {
    ...
    SimpleDateFormat f = new SimpleDateFormat("'['dd/MMM/yyyy:HH:mm:ss Z']'");
    String s = f.format(d) + " MODIFY FORWARD conn=1 op=2 msgID=3 " +
