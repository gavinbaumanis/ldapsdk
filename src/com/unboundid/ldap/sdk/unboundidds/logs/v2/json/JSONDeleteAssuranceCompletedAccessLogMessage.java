 ...
 * JSON-formatted delete assurance completed access log message.
 * <BR>
 * <BLOCKQUOTE>
...
public final class JSONDeleteAssuranceCompletedAccessLogMessage
       extends JSONDeleteResultAccessLogMessage
       implements DeleteAssuranceCompletedAccessLogMessage
{
  /**
   * The serial version UID for this serializable class.
   */
  private static final long serialVersionUID = -7799508687553172516L;
  ...
  /**
   * Creates a new JSON delete assurance completed access log message from the
   ...
   *                        valid log message.
   */
  public JSONDeleteAssuranceCompletedAccessLogMessage(
