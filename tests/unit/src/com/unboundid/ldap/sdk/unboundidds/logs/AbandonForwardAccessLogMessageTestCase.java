 ...
 * {@code AbandonForwardAccessLogMessage} class.
 */
public class AbandonForwardAccessLogMessageTestCase
       extends LDAPSDKTestCase
{
         ...
         throws Exception
  {
    ...
    AbandonForwardAccessLogMessage m = new AbandonForwardAccessLogMessage(s);
    m = new AbandonForwardAccessLogMessage(m);
         ...
         throws Exception
  {
    ...
    SimpleDateFormat f = new SimpleDateFormat("'['dd/MMM/yyyy:HH:mm:ss Z']'");
    String s = f.format(d) + " ABANDON FORWARD conn=1 op=2 msgID=3 " +
