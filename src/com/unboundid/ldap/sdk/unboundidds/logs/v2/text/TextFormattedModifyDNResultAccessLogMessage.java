       ...
       implements ModifyDNResultAccessLogMessage
{
   ...
   */
  private static final long serialVersionUID = -6465567340975637801L;
  ...
  /**
   * Creates a new text-formatted modify DN result access log message from the
   ...
   *                        log message.
   */
  public TextFormattedModifyDNResultAccessLogMessage(
   ...
   * provided message.
   *
   * @param  logMessage  The log message to use to create this modify DN result
