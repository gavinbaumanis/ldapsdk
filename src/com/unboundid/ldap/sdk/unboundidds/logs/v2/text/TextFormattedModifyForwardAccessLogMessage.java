...
import com.unboundid.ldap.sdk.unboundidds.logs.v2.ModifyForwardAccessLogMessage;
 ...
 * text-formatted modify forward access log message.
 * <BR>
 * <BLOCKQUOTE>
...
public class TextFormattedModifyForwardAccessLogMessage
       extends TextFormattedModifyRequestAccessLogMessage
       implements ModifyForwardAccessLogMessage
{
  /**
   * The serial version UID for this serializable class.
   */
  private static final long serialVersionUID = -3134269910195416978L;
  ...
  /**
   * Creates a new text-formatted modify forward access log message from the
   ...
   *                        log message.
   */
  public TextFormattedModifyForwardAccessLogMessage(
