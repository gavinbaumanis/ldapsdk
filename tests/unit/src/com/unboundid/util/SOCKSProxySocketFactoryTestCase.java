 ...
 */
/*
 * Copyright (C) 2023-2026 Ping Identity Corporation
 *
...
/**
 * This class provides test coverage for the {@code SOCKSProxySocketFactory}
 * class.  Note, however, that since we can't guarantee the existence of a SOCKS
 ...
 * coverage.
 */
public final class SOCKSProxySocketFactoryTestCase
       extends LDAPSDKTestCase
{
  // The port to use when trying to communicate with a SOCKS proxy server.  This
         ...
         throws Exception
  {
    ...
    ds.startListening();
    socksProxyPort = ds.getListenPort();
    ds.shutDown(true);
  }
  ...
  public void testWithoutSSLSocketFactory()
         throws Exception
  {
    final SOCKSProxySocketFactory socketFactory = new SOCKSProxySocketFactory(
         "127.0.0.1", socksProxyPort, 123);
    ...
    {
      // This is expected when no SOCKS proxy is actually available.
    }
  ...
  {
    final SOCKSProxySocketFactory socketFactory = new SOCKSProxySocketFactory(
         "127.0.0.1", socksProxyPort, 123, null);
         ...
         throws Exception
  {
    ...
    final SOCKSProxySocketFactory socketFactory = new SOCKSProxySocketFactory(
         "127.0.0.1", socksProxyPort, 123, sslUtil.createSSLSocketFactory());
