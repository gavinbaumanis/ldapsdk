...
/**
 * This class provides a set of test cases for the SearchAndModRate class.
 */
public class SearchAndModRateTestCase
       extends LDAPSDKTestCase
{
  ...
  public void provideGeneralTestCoverage()
         throws Exception
  {
    final SearchAndModRate tool = new SearchAndModRate(null, null);
         ...
         throws Exception
  {
    ...
    assertEquals(SearchAndModRate.main(args, null, null), ResultCode.SUCCESS);
  }
         ...
         throws Exception
  {
    ...
    assertFalse(SearchAndModRate.main(args, null, null) == ResultCode.SUCCESS);
  }
         ...
         throws Exception
  {
    ...
    String[] args =
    {
      ...
      "--searchAssertionFilter", "(objectClass=*)",
      "--modifyAssertionFilter", "(objectClass=*)",
      "--simplePageSize", "1",
      "--permissiveModify",
      "--preReadAttribute", "*",
      "--preReadAttribute", "+",
      ...
      "--modifyControl", "2.16.840.1.113730.3.4.2:false"
    };
    assertEquals(SearchAndModRate.main(args, null, null),
         ResultCode.SUCCESS);
  }
         ...
         throws Exception
  {
    ...
    final SearchAndModRate searchAndModRate = new SearchAndModRate(null, null);
    final String[] args =
    {
      "-h", getTestHost(),
      "-p", String.valueOf(getTestPort()),
    ...
    new Thread()
    {
      ...
      public void run()
      {
        ...
        searchAndModRate.stopRunning();
      }
    }.start();

    assertEquals(searchAndModRate.runTool(args), ResultCode.SUCCESS);
  }
}
