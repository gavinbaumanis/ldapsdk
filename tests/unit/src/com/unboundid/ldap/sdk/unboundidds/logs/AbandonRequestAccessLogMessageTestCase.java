 ...
 * {@code AbandonRequestAccessLogMessage} class.
 */
public class AbandonRequestAccessLogMessageTestCase
       extends LDAPSDKTestCase
{
         ...
         throws Exception
  {
    ...
    AbandonRequestAccessLogMessage m = new AbandonRequestAccessLogMessage(s);
    m = new AbandonRequestAccessLogMessage(m);
         ...
         throws Exception
  {
    ...
    SimpleDateFormat f = new SimpleDateFormat("'['dd/MMM/yyyy:HH:mm:ss Z']'");
    String s = f.format(d) + " ABANDON REQUEST conn=1 op=2 msgID=3 " +
               "idToAbandon=4";
         ...
         throws Exception
  {
    ...
    String s = f.format(d) + " ABANDON REQUEST " +
               ...
               "idToAbandon=4 triggeredByConn=987 triggeredByOp=654";
