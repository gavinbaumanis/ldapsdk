       ...
       extends Control
{
  ...
  public JSONObject toJSONControl()
  {
    return new JSONObject(
         ...
         new JSONField(JSONControlDecodeHelper.JSON_FIELD_CONTROL_NAME,
              INFO_CONTROL_NAME_MANAGE_DSAIT_REQUEST.get()),
   ...
   *
   * @return  The ManageDsaIT request control that was decoded from the provided
   *          JSON object.
   *
   * @throws  LDAPException  If the provided JSON object cannot be parsed as a
   *                         valid ManageDsaIT request control.
   */
  @NotNull()
  public static ManageDsaITRequestControl decodeJSONControl(
