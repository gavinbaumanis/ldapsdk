 ...
 * {@code CompareForwardFailedAccessLogMessage} class.
 */
public class CompareForwardFailedAccessLogMessageTestCase
       extends LDAPSDKTestCase
{
         ...
         throws Exception
  {
    ...
    CompareForwardFailedAccessLogMessage m =
         new CompareForwardFailedAccessLogMessage(s);
    m = new CompareForwardFailedAccessLogMessage(m);
         ...
         throws Exception
  {
    ...
    SimpleDateFormat f = new SimpleDateFormat("'['dd/MMM/yyyy:HH:mm:ss Z']'");
    String s = f.format(d) + " COMPARE FORWARD-FAILED conn=1 op=2 msgID=3 " +
