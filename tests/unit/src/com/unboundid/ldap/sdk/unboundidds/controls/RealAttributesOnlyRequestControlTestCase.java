       ...
       extends LDAPSDKTestCase
{
  ...
  public void testToJSONControl()
          throws Exception
  {
    final RealAttributesOnlyRequestControl c =
         new RealAttributesOnlyRequestControl(false);
    ...
    RealAttributesOnlyRequestControl decodedControl =
         RealAttributesOnlyRequestControl.decodeJSONControl(controlObject,
              true);
