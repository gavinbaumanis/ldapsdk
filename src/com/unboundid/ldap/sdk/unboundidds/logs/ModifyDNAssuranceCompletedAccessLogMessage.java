       ...
       extends ModifyDNResultAccessLogMessage
{
  ...
  /**
   * Creates a new modify DN assurance complete access log message from the
   * provided message string.
   *
   * @param  s  The string to be parsed as an modify DN assurance complete
   *            access log message.
   *
   * @throws  LogException  If the provided string cannot be parsed as a valid
   *                        log message.
   */
  public ModifyDNAssuranceCompletedAccessLogMessage(@NotNull final String s)
         throws LogException
  {
   ...
   * provided message string.
   *
   * @param  m  The log message to be parsed as an modify DN assurance complete
   *            access log message.
   */
  public ModifyDNAssuranceCompletedAccessLogMessage(@NotNull final LogMessage m)
  {
    super(m);
