 ...
 * {@code AddForwardAccessLogMessage} class.
 */
public class AddForwardAccessLogMessageTestCase
       extends LDAPSDKTestCase
{
         ...
         throws Exception
  {
    ...
    AddForwardAccessLogMessage m = new AddForwardAccessLogMessage(s);
    m = new AddForwardAccessLogMessage(m);
         ...
         throws Exception
  {
    ...
    SimpleDateFormat f = new SimpleDateFormat("'['dd/MMM/yyyy:HH:mm:ss Z']'");
    String s = f.format(d) + " ADD FORWARD conn=1 op=2 msgID=3 " +
