 ...
 * JSON-formatted modify DN request access log message.
 * <BR>
 * <BLOCKQUOTE>
...
public class JSONModifyDNRequestAccessLogMessage
       ...
       implements ModifyDNRequestAccessLogMessage
{
   ...
   */
  private static final long serialVersionUID = 4129391735909212011L;
  ...
  /**
   * Creates a new JSON modify DN request access log message from the provided
   * JSON object.
   *
   ...
   *                        valid log message.
   */
  public JSONModifyDNRequestAccessLogMessage(
              @NotNull final JSONObject jsonObject)
         throws LogException
  {
    super(jsonObject);

    dn = getString(JSONFormattedAccessLogFields.MODDN_ENTRY_DN);
    newRDN = getString(JSONFormattedAccessLogFields.MODDN_NEW_RDN);
    deleteOldRDN =
         getBooleanNoThrow(JSONFormattedAccessLogFields.MODDN_DELETE_OLD_RDN);
    newSuperiorDN =
         getString(JSONFormattedAccessLogFields.MODDN_NEW_SUPERIOR_DN);
  }
