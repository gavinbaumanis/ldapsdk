       ...
       implements OperationResultAccessLogMessage
{
  ...
  /**
   * Creates a new modify DN result access log message from the provided message
   * string.
   *
   * @param  s  The string to be parsed as a modify DN result access log
   *            message.
   *
   * @throws  LogException  If the provided string cannot be parsed as a valid
   *                        log message.
   */
  public ModifyDNResultAccessLogMessage(@NotNull final String s)
         throws LogException
  {
  ...
  /**
   * Creates a new modify DN result access log message from the provided log
   * message.
   *
   * @param  m  The log message to be parsed as a modify DN result access log
   *            message.
   */
  public ModifyDNResultAccessLogMessage(@NotNull final LogMessage m)
  {
    super(m);
