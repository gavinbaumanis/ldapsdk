 ...
 * {@code DeleteForwardAccessLogMessage} class.
 */
public class DeleteForwardAccessLogMessageTestCase
       extends LDAPSDKTestCase
{
         ...
         throws Exception
  {
    ...
    DeleteForwardAccessLogMessage m = new DeleteForwardAccessLogMessage(s);
    m = new DeleteForwardAccessLogMessage(m);
         ...
         throws Exception
  {
    ...
    SimpleDateFormat f = new SimpleDateFormat("'['dd/MMM/yyyy:HH:mm:ss Z']'");
    String s = f.format(d) + " DELETE FORWARD conn=1 op=2 msgID=3 " +
