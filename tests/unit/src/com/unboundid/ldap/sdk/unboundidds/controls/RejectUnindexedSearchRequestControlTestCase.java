...
/**
 * This class provides a set of test cases for the reject unindexed search
 * request control.
 */
public final class RejectUnindexedSearchRequestControlTestCase
       extends LDAPSDKTestCase
{
  ...
  public void testDefaultConstructor()
         throws Exception
  {
    RejectUnindexedSearchRequestControl c =
         new RejectUnindexedSearchRequestControl();

    c = new RejectUnindexedSearchRequestControl(c);

    assertNotNull(c.getOID());
    assertEquals(c.getOID(), "1.3.6.1.4.1.30221.2.5.54");
  ...
  {
    RejectUnindexedSearchRequestControl c =
         new RejectUnindexedSearchRequestControl(true);
  ...
  {
    RejectUnindexedSearchRequestControl c =
         new RejectUnindexedSearchRequestControl(false);
  ...
  public void testToJSONControl()
          throws Exception
  {
    final RejectUnindexedSearchRequestControl c =
         new RejectUnindexedSearchRequestControl(false);
    ...
    RejectUnindexedSearchRequestControl decodedControl =
         RejectUnindexedSearchRequestControl.decodeJSONControl(controlObject,
              true);
