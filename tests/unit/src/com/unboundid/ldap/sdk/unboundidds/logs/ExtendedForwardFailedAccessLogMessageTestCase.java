 ...
 * {@code ExtendedForwardFailedAccessLogMessage} class.
 */
public class ExtendedForwardFailedAccessLogMessageTestCase
       extends LDAPSDKTestCase
{
         ...
         throws Exception
  {
    ...
    ExtendedForwardFailedAccessLogMessage m =
         new ExtendedForwardFailedAccessLogMessage(s);
    m = new ExtendedForwardFailedAccessLogMessage(m);
         ...
         throws Exception
  {
    ...
    SimpleDateFormat f = new SimpleDateFormat("'['dd/MMM/yyyy:HH:mm:ss Z']'");
    String s = f.format(d) + " EXTENDED FORWARD-FAILED conn=1 op=2 msgID=3 " +
