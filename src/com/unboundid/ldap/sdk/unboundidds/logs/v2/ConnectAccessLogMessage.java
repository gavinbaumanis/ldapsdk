...
/**
 * This class provides a data structure that holds information about a connect
 * access log message.
 * <BR>
 * <BLOCKQUOTE>
...
public interface ConnectAccessLogMessage
       extends AccessLogMessage
{
   ...
   *
   * @return  The source port for the client connection, or {@code null} if
   *          it is not included in the log message.
   */
  @Nullable()
   ...
   *
   * @return  The target port for the client connection, or {@code null} if
   *          it is not included in the log message.
   */
  @Nullable()
