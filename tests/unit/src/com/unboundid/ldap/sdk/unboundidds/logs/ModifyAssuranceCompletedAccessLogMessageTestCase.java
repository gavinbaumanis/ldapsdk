 ...
 * {@code ModifyAssuranceCompletedAccessLogMessage} class.
 */
public class ModifyAssuranceCompletedAccessLogMessageTestCase
       extends LDAPSDKTestCase
{
         ...
         throws Exception
  {
    ...
    ModifyAssuranceCompletedAccessLogMessage m =
         new ModifyAssuranceCompletedAccessLogMessage(s);
    m = new ModifyAssuranceCompletedAccessLogMessage(m);
         ...
         throws Exception
  {
    ...
    SimpleDateFormat f = new SimpleDateFormat("'['dd/MMM/yyyy:HH:mm:ss Z']'");
    String s = f.format(d) + " MODIFY ASSURANCE-COMPLETE conn=1 op=2 msgID=3 " +
