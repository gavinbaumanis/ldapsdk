 ...
 * JSON-formatted bind forward access log message.
 * <BR>
 * <BLOCKQUOTE>
...
public class JSONBindForwardAccessLogMessage
       ...
       implements BindForwardAccessLogMessage
{
   ...
   */
  private static final long serialVersionUID = 1038878744449821879L;
  ...
  /**
   * Creates a new JSON bind forward access log message from the provided
   * JSON object.
   *
   ...
   *                        valid log message.
   */
  public JSONBindForwardAccessLogMessage(@NotNull final JSONObject jsonObject)
         throws LogException
  {
    super(jsonObject);
