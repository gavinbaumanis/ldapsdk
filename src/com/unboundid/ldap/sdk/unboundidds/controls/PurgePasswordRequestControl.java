       ...
       extends Control
{
  ...
  /**
   * Retrieves a representation of this purge password request control as a JSON
   ...
   *     identifier for this control.  For the purge password request control,
   *     the OID is "1.3.6.1.4.1.30221.2.5.32".
   *   </LI>
   *   <LI>
  ...
  public JSONObject toJSONControl()
  {
    return new JSONObject(
         ...
         new JSONField(JSONControlDecodeHelper.JSON_FIELD_CONTROL_NAME,
              INFO_CONTROL_NAME_PURGE_PASSWORD_REQUEST.get()),
   ...
   *
   * @return  The purge password request control that was decoded from
   *          the provided JSON object.
   *
   * @throws  LDAPException  If the provided JSON object cannot be parsed as a
   *                         valid purge password request control.
   */
  @NotNull()
  public static PurgePasswordRequestControl decodeJSONControl(
         ...
         throws LDAPException
  {
    ...
    return new PurgePasswordRequestControl(jsonControl.getCriticality());
  }
