 ...
 * a {@link PurgeRetiredListenerCertificatesExtendedRequest}.  See the
...
public final class PurgeRetiredListenerCertificatesExtendedResult
       extends ReplaceCertificateExtendedResult
{
  /**
   * The serial version UID for this serializable class.
   */
  private static final long serialVersionUID = -2354498285273313916L;



  /**
   * Creates a new purge retired listener certificates extended result that is
   * decoded from the provided extended result.
   *
   * @param  extendedResult  The generic extended result to decode as a purge
   *                         retired listener certificates extended result.  It
   *                         must not be {@code null}.
   *
   * @throws  LDAPException  If the provided extended result cannot be decoded
   *                         as a purge retired listener certificates extended
   *                         result.
   */
  public PurgeRetiredListenerCertificatesExtendedResult(
  ...
  /**
   * Creates a new purge retired listener certificates extended result with the
   ...
   */
  public PurgeRetiredListenerCertificatesExtendedResult(final int messageID,
              ...
              @Nullable final Control... responseControls)
  {
    super(messageID, resultCode, diagnosticMessage, matchedDN, referralURLs,
         PurgeRetiredListenerCertificatesExtendedRequest.
              PURGE_RETIRED_LISTENER_CERTS_REQUEST_OID,
