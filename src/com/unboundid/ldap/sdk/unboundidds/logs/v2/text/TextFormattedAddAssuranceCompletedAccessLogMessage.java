 ...
 * text-formatted add assurance completed access log message.
 * <BR>
 * <BLOCKQUOTE>
...
public final class TextFormattedAddAssuranceCompletedAccessLogMessage
       extends TextFormattedAddResultAccessLogMessage
       implements AddAssuranceCompletedAccessLogMessage
{
  /**
   * The serial version UID for this serializable class.
   */
  private static final long serialVersionUID = 9123713818149427056L;
  ...
  /**
   * Creates a new text-formatted add assurance completed access log message
   ...
   *                        log message.
   */
  public TextFormattedAddAssuranceCompletedAccessLogMessage(
   ...
   *
   * @param  logMessage  The log message to use to create this add assurance
