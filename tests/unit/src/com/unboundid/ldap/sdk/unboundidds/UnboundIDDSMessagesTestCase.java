...
/**
 * This class provides test coverage for the UnboundIDDSMessages class.
 */
public class UnboundIDDSMessagesTestCase
       extends LDAPSDKTestCase
{
  ...
  public void testMessageDefined(final UnboundIDDSMessages m)
         throws Exception
  {
    assertNotNull(m);

    assertEquals(UnboundIDDSMessages.valueOf(m.name()), m);
  ...
  {
    UnboundIDDSMessages[] values = UnboundIDDSMessages.values();
