 ...
 * text-formatted abandon result access log message.
 * <BR>
 * <BLOCKQUOTE>
...
public final class TextFormattedAbandonResultAccessLogMessage
       ...
       implements AbandonResultAccessLogMessage
{
   ...
   */
  private static final long serialVersionUID = 1458072867087821708L;
  ...
  /**
   * Creates a new text-formatted abandon result access log message from the
   ...
   *                        log message.
   */
  public TextFormattedAbandonResultAccessLogMessage(
   ...
   * provided message.
   *
   * @param  logMessage  The log message to use to create this abandon result
