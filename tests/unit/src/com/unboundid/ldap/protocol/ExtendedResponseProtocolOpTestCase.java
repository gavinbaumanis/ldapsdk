 ...
 * {@code ExtendedResponseProtocolOp} class.
 */
public class ExtendedResponseProtocolOpTestCase
       extends LDAPSDKTestCase
{
   ...
   */
  @Test()
  public void testExtendedResponseProtocolOpSuccess()
         throws Exception
  {
    ExtendedResponseProtocolOp op = new ExtendedResponseProtocolOp(0, null,
        null, null, "1.2.3.4", new ASN1OctetString());
   ...
   */
  @Test()
  public void testExtendedResponseProtocolOpFailure()
         throws Exception
  {
    ...
    ExtendedResponseProtocolOp op = new ExtendedResponseProtocolOp(32,
  ...
  /**
   * Tests the behavior when attempting to create an extended response protocol
         ...
         throws Exception
  {
    ...
    final ExtendedResponseProtocolOp op = new ExtendedResponseProtocolOp(r);
  ...
  public void testReadMalformedExtendedResponse()
         throws Exception
  {
  ...
  /**
   * Tests the behavior when trying to decode a malformed extended response.
   *
   * @throws  Exception  If an unexpected problem occurs.
   */
  @Test(expectedExceptions = { LDAPException.class })
  public void testDecodeMalformedExtendedResponse()
         throws Exception
  {
    ExtendedResponseProtocolOp.decodeProtocolOp(
         new ASN1Element(LDAPMessage.PROTOCOL_OP_TYPE_EXTENDED_RESPONSE));
  }
   ...
   */
  @Test(expectedExceptions = { LDAPException.class })
  public void testReadExtendedResponseInvalidElementType()
         throws Exception
  {
  ...
  /**
   * Tests the behavior when trying to decode an extended response with an
   * invalid element type.
   *
   * @throws  Exception  If an unexpected problem occurs.
   */
  @Test(expectedExceptions = { LDAPException.class })
  public void testDecodeExtendedResponseInvalidElementType()
         throws Exception
  {
    ...
    ExtendedResponseProtocolOp.decodeProtocolOp(s);
  }
}
