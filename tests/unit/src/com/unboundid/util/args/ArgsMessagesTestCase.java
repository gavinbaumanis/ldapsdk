...
/**
 * This class provides test coverage for the ArgsMessages class.
 */
public class ArgsMessagesTestCase
       extends UtilTestCase
{
  ...
  public void testMessageDefined(final ArgsMessages m)
         throws Exception
  {
    assertNotNull(m);

    assertEquals(ArgsMessages.valueOf(m.name()), m);
  ...
  {
    ArgsMessages[] values = ArgsMessages.values();
