 ...
 * text-formatted compare forward access log message.
 * <BR>
 * <BLOCKQUOTE>
...
public class TextFormattedCompareForwardAccessLogMessage
       extends TextFormattedCompareRequestAccessLogMessage
       implements CompareForwardAccessLogMessage
{
  /**
   * The serial version UID for this serializable class.
   */
  private static final long serialVersionUID = 6171400217176344878L;
  ...
  /**
   * Creates a new text-formatted compare forward access log message from the
   ...
   *                        log message.
   */
  public TextFormattedCompareForwardAccessLogMessage(
