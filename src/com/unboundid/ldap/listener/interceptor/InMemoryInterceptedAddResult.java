...
public interface InMemoryInterceptedAddResult
       extends InMemoryInterceptedResult
{
  /**
   * Retrieves the add request that was processed.  If the request was altered
   * between the time it was received from the client and the time it was
   * actually processed by the in-memory directory server, then this will be the
   * most recently altered version.
   *
   * @return  The add request that was processed.
   */
  @NotNull()
   ...
   *
   * @return  The add result to be returned to the client.
   */
  @Nullable()
   ...
   *
   * @param  addResult  The add result that should be returned to the client
