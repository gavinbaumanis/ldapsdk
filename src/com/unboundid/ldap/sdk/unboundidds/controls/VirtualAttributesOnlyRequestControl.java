       ...
       extends Control
{
  ...
  public JSONObject toJSONControl()
  {
    return new JSONObject(
         ...
         new JSONField(JSONControlDecodeHelper.JSON_FIELD_CONTROL_NAME,
              INFO_CONTROL_NAME_VIRTUAL_ATTRS_ONLY_REQUEST.get()),
   ...
   *
   * @return  The virtual attributes only request control that was decoded from
   *          the provided JSON object.
   *
   * @throws  LDAPException  If the provided JSON object cannot be parsed as a
   *                         valid virtual attributes only request control.
   */
  @NotNull()
  public static VirtualAttributesOnlyRequestControl decodeJSONControl(
         ...
         throws LDAPException
  {
    ...
    return new VirtualAttributesOnlyRequestControl(
