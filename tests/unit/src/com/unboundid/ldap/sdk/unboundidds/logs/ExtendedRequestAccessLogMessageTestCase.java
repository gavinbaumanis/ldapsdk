 ...
 * {@code ExtendedRequestAccessLogMessage} class.
 */
public class ExtendedRequestAccessLogMessageTestCase
       extends LDAPSDKTestCase
{
         ...
         throws Exception
  {
    ...
    ExtendedRequestAccessLogMessage m = new ExtendedRequestAccessLogMessage(s);
    m = new ExtendedRequestAccessLogMessage(m);
         ...
         throws Exception
  {
    ...
    SimpleDateFormat f = new SimpleDateFormat("'['dd/MMM/yyyy:HH:mm:ss Z']'");
    String s = f.format(d) + " EXTENDED REQUEST conn=1 op=2 msgID=3 " +
               "requestOID=\"5.6.7.8\"";
         ...
         throws Exception
  {
    ...
    String s = f.format(d) + " EXTENDED REQUEST " +
               ...
               "requestOID=\"5.6.7.8\" triggeredByConn=987 triggeredByOp=654";
