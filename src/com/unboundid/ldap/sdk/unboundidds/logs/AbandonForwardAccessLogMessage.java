...
public final class AbandonForwardAccessLogMessage
       extends AbandonRequestAccessLogMessage
{
  ...
  /**
   * Creates a new abandon forward access log message from the provided message
   * string.
   *
   * @param  s  The string to be parsed as an abandon forward access log
   *            message.
   *
   * @throws  LogException  If the provided string cannot be parsed as a valid
   *                        log message.
   */
  public AbandonForwardAccessLogMessage(@NotNull final String s)
         throws LogException
  {
  ...
  /**
   * Creates a new abandon forward access log message from the provided log
   * message.
   *
   * @param  m  The log message to be parsed as an abandon forward access log
   *            message.
   */
  public AbandonForwardAccessLogMessage(@NotNull final LogMessage m)
  {
    super(m);
