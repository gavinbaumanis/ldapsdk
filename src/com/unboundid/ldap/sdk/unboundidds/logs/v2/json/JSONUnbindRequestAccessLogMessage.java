 ...
 * JSON-formatted unbind request access log message.
 * <BR>
 * <BLOCKQUOTE>
...
public final class JSONUnbindRequestAccessLogMessage
       ...
       implements UnbindRequestAccessLogMessage
{
  ...
  /**
   * Creates a new JSON unbind request access log message from the provided
   * JSON object.
   *
   ...
   *                        valid log message.
   */
  public JSONUnbindRequestAccessLogMessage(
