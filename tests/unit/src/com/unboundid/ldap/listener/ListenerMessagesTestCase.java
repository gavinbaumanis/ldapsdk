...
/**
 * This class provides test coverage for the ListenerMessages class.
 */
public class ListenerMessagesTestCase
       extends LDAPSDKTestCase
{
  ...
  public void testMessageDefined(final ListenerMessages m)
         throws Exception
  {
    assertNotNull(m);

    assertEquals(ListenerMessages.valueOf(m.name()), m);
  ...
  {
    ListenerMessages[] values = ListenerMessages.values();
