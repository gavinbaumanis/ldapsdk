 ...
 * properties.
 */
public final class RemoveObjectClassTaskPropertiesTestCase
       extends LDAPSDKTestCase
{
  ...
  public void testDefaultProperties()
         throws Exception
  {
    RemoveObjectClassTaskProperties p =
         new RemoveObjectClassTaskProperties("ocName");
    p = new RemoveObjectClassTaskProperties(p);

    assertNotNull(p.getObjectClass());
    assertEquals(p.getObjectClass(), "ocName");
  ...
  /**
   * Tests the behavior related to the object class property.
   *
   * @throws  Exception  If an unexpected problem occurs.
   */
  @Test()
         ...
         throws Exception
  {
    ...
    p = new RemoveObjectClassTaskProperties(p);
    p = new RemoveObjectClassTaskProperties(new RemoveObjectClassTask(p));

    assertNotNull(p.getObjectClass());
    assertEquals(p.getObjectClass(), "differentOCName");
