 ...
 * subscription extended request.
 */
public final class DeleteNotificationSubscriptionExtendedRequestTestCase
       extends LDAPSDKTestCase
{
  ...
  public void testWithoutControls()
         throws Exception
  {
    DeleteNotificationSubscriptionExtendedRequest r =
         new DeleteNotificationSubscriptionExtendedRequest("test-manager-id",
              "test-dest-id", "test-sub-id");

    r = new DeleteNotificationSubscriptionExtendedRequest(r);
         ...
         throws Exception
  {
    DeleteNotificationSubscriptionExtendedRequest r =
         new DeleteNotificationSubscriptionExtendedRequest("test-manager-id",
              "test-dest-id", "test-sub-id", new Control("1.2.3.4"),
  ...
  public void testDecodeNoValue()
         throws Exception
  {
    new DeleteNotificationSubscriptionExtendedRequest(
         new ExtendedRequest("1.3.6.1.4.1.30221.2.6.39"));
  }
