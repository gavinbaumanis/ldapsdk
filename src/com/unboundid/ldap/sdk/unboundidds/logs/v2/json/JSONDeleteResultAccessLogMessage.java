 ...
 * JSON-formatted delete result access log message.
 * <BR>
 * <BLOCKQUOTE>
...
public class JSONDeleteResultAccessLogMessage
       extends JSONDeleteRequestAccessLogMessage
       implements DeleteResultAccessLogMessage
{
  ...
  /**
   * Creates a new JSON delete result access log message from the provided JSON
   * object.
   *
   ...
   *                        valid log message.
   */
  public JSONDeleteResultAccessLogMessage(@NotNull final JSONObject jsonObject)
         throws LogException
  {
    super(jsonObject);

    softDeletedEntryDN =
         getString(JSONFormattedAccessLogFields.DELETE_SOFT_DELETED_ENTRY_DN);
