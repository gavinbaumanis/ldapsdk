 ...
 * JSON-formatted modify DN forward access log message.
 * <BR>
 * <BLOCKQUOTE>
...
public class JSONModifyDNForwardAccessLogMessage
       extends JSONModifyDNRequestAccessLogMessage
       implements ModifyDNForwardAccessLogMessage
{
  /**
   * The serial version UID for this serializable class.
   */
  private static final long serialVersionUID = -5523718333315416429L;
  ...
  /**
   * Creates a new JSON modify DN forward access log message from the provided
   * JSON object.
   *
   ...
   *                        valid log message.
   */
  public JSONModifyDNForwardAccessLogMessage(
