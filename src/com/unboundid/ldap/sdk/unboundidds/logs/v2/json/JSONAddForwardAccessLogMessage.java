 ...
 * JSON-formatted add forward access log message.
 * <BR>
 * <BLOCKQUOTE>
...
public class JSONAddForwardAccessLogMessage
       ...
       implements AddForwardAccessLogMessage
{
   ...
   */
  private static final long serialVersionUID = 2970123753830331286L;
  ...
  /**
   * Creates a new JSON add forward access log message from the provided
   * JSON object.
   *
   ...
   *                        valid log message.
   */
  public JSONAddForwardAccessLogMessage(@NotNull final JSONObject jsonObject)
         throws LogException
  {
    super(jsonObject);
