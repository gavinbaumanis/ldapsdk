...
/**
 * This class provides test coverage for the InterceptorMessages class.
 */
public class InterceptorMessagesTestCase
       extends LDAPSDKTestCase
{
  ...
  public void testMessageDefined(final InterceptorMessages m)
         throws Exception
  {
    assertNotNull(m);

    assertEquals(InterceptorMessages.valueOf(m.name()), m);
  ...
  {
    InterceptorMessages[] values = InterceptorMessages.values();
