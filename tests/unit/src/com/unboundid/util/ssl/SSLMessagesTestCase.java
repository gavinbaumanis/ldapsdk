...
/**
 * This class provides test coverage for the SSLMessages class.
 */
public class SSLMessagesTestCase
       extends SSLTestCase
{
  /**
  ...
  public void testMessageDefined(final SSLMessages m)
         throws Exception
  {
    assertNotNull(m);

    assertEquals(SSLMessages.valueOf(m.name()), m);
  ...
  {
    SSLMessages[] values = SSLMessages.values();
