 ...
 * JSON-formatted abandon forward access log message.
 * <BR>
 * <BLOCKQUOTE>
...
public class JSONAbandonForwardAccessLogMessage
       ...
       implements AbandonForwardAccessLogMessage
{
   ...
   */
  private static final long serialVersionUID = -611011808658041354L;
  ...
  /**
   * Creates a new JSON abandon forward access log message from the provided
   * JSON object.
   *
   ...
   *                        valid log message.
   */
  public JSONAbandonForwardAccessLogMessage(
