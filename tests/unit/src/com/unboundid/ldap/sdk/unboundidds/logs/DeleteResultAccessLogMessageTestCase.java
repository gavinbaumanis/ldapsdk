 ...
 * {@code DeleteResultAccessLogMessage} class.
 */
public class DeleteResultAccessLogMessageTestCase
       extends LDAPSDKTestCase
{
         ...
         throws Exception
  {
    ...
    DeleteResultAccessLogMessage m = new DeleteResultAccessLogMessage(s);
    m = new DeleteResultAccessLogMessage(m);
         ...
         throws Exception
  {
    ...
    SimpleDateFormat f = new SimpleDateFormat("'['dd/MMM/yyyy:HH:mm:ss Z']'");
    String s = f.format(d) + " DELETE RESULT conn=1 op=2 msgID=3 " +
