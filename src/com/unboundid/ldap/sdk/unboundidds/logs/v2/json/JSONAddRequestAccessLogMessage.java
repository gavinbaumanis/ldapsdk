 ...
 * JSON-formatted add request access log message.
 * <BR>
 * <BLOCKQUOTE>
...
public class JSONAddRequestAccessLogMessage
       ...
       implements AddRequestAccessLogMessage
{
   ...
   *                        valid log message.
   */
  public JSONAddRequestAccessLogMessage(@NotNull final JSONObject jsonObject)
         throws LogException
  {
    super(jsonObject);

    dn = getString(JSONFormattedAccessLogFields.ADD_ENTRY_DN);
    attributeNames = getStringSet(JSONFormattedAccessLogFields.ADD_ATTRIBUTES);
  }
