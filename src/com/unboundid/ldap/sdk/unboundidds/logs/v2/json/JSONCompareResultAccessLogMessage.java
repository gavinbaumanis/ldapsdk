 ...
 * JSON-formatted compare result access log message.
 * <BR>
 * <BLOCKQUOTE>
...
public final class JSONCompareResultAccessLogMessage
       extends JSONCompareRequestAccessLogMessage
       implements CompareResultAccessLogMessage
{
  /**
   * The serial version UID for this serializable class.
   */
  private static final long serialVersionUID = 1348301787691529988L;
  ...
  /**
   * Creates a new JSON compare result access log message from the provided JSON
   * object.
   *
   ...
   *                        valid log message.
   */
  public JSONCompareResultAccessLogMessage(@NotNull final JSONObject jsonObject)
         throws LogException
  {
    super(jsonObject);
