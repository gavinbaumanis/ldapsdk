...
/**
 * This class provides a set of test cases for the replace listener certificate
 * extended result.
 */
public final class ReplaceListenerCertificateExtendedResultTestCase
     extends LDAPSDKTestCase
{
         ...
         throws Exception
  {
    ...
    ReplaceListenerCertificateExtendedResult r =
         new ReplaceListenerCertificateExtendedResult(2,
    ...
    r = new ReplaceListenerCertificateExtendedResult(r);
         ...
         throws Exception
  {
    ...
    ReplaceListenerCertificateExtendedResult r =
         new ReplaceListenerCertificateExtendedResult(3,
  ...
  public void testDecodeResultWithoutOIDOrValue()
         throws Exception
  {
    final ReplaceListenerCertificateExtendedResult r =
         new ReplaceListenerCertificateExtendedResult(new ExtendedResult(4,
