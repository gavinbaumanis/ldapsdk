 ...
 * JSON-formatted search result access log message.
 * <BR>
 * <BLOCKQUOTE>
...
public final class JSONSearchResultAccessLogMessage
       ...
       implements SearchResultAccessLogMessage
{
   ...
   */
  private static final long serialVersionUID = 1765439451592454553L;
   ...
   *                        valid log message.
   */
  public JSONSearchResultAccessLogMessage(@NotNull final JSONObject jsonObject)
         throws LogException
  {
    super(jsonObject);

    entriesReturned =
         getLongNoThrow(JSONFormattedAccessLogFields.SEARCH_ENTRIES_RETURNED);

    final Boolean isIndexed = getBooleanNoThrow(
         JSONFormattedAccessLogFields.SEARCH_INDEXED);
    if (isIndexed == null)
    {
      isUnindexed = null;
    }
