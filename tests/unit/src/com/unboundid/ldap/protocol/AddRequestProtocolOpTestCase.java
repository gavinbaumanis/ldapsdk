...
/**
 * This class provides a set of test cases for the {@code AddRequestProtocolOp}
 * class.
 */
public class AddRequestProtocolOpTestCase
       extends LDAPSDKTestCase
{
   ...
   */
  @Test()
  public void testAddRequestProtocolOp()
         throws Exception
  {
  ...
  /**
   * Tests the behavior when trying to decode a malformed add request.
   *
   * @throws  Exception  If an unexpected problem occurs.
   */
  @Test(expectedExceptions = { LDAPException.class })
  public void testDecodeMalformedRequest()
         throws Exception
  {
    AddRequestProtocolOp.decodeProtocolOp(
         new ASN1Element(LDAPMessage.PROTOCOL_OP_TYPE_ADD_REQUEST));
  }
