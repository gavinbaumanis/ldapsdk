...
public final class ModifyAssuranceCompletedAccessLogMessage
       extends ModifyResultAccessLogMessage
{
  /**
   ...
   *
   * @param  s  The string to be parsed as an modify assurance complete access
   *            log message.
   *
