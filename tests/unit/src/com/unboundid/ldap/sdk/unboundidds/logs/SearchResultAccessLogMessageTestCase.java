 ...
 * {@code SearchResultAccessLogMessage} class.
 */
public class SearchResultAccessLogMessageTestCase
       extends LDAPSDKTestCase
{
         ...
         throws Exception
  {
    ...
    SearchResultAccessLogMessage m = new SearchResultAccessLogMessage(s);
    m = new SearchResultAccessLogMessage(m);
    ...
    assertNull(m.getEntriesReturned());

    assertNull(m.isUnindexed());
         ...
         throws Exception
  {
    ...
    String s = f.format(d) + " SEARCH RESULT conn=1 op=2 msgID=3 " +
               "resultCode=0 etime=0.123 entriesReturned=1 " +
               "serversAccessed=\"1.2.3.4:389\" uncachedDataAccessed=true";
