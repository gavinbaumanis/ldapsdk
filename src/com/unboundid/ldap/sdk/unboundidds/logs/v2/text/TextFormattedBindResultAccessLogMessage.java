 ...
 * text-formatted bind result access log message.
 * <BR>
 * <BLOCKQUOTE>
       ...
       implements BindResultAccessLogMessage
{
  ...
  /**
   * Creates a new text-formatted bind result access log message from the
   ...
   *                        log message.
   */
  public TextFormattedBindResultAccessLogMessage(
   ...
   * provided message.
   *
   * @param  logMessage  The log message to use to create this bind result
       ...
       @NotNull final TextFormattedLogMessage logMessage)
  {
    ...
    authenticationDN =
         getString(TextFormattedAccessLogFields.BIND_AUTHENTICATION_DN);
    authorizationDN =
         getString(TextFormattedAccessLogFields.BIND_AUTHORIZATION_DN);
    retiredPasswordUsed = getBooleanNoThrow(
         TextFormattedAccessLogFields.BIND_RETIRED_PASSWORD_USED);
    clientConnectionPolicy =
         getString(TextFormattedAccessLogFields.CLIENT_CONNECTION_POLICY);
    authenticationFailureID = getLongNoThrow(
         TextFormattedAccessLogFields.BIND_AUTHENTICATION_FAILURE_ID);
    authenticationFailureName = getString(
         TextFormattedAccessLogFields.BIND_AUTHENTICATION_FAILURE_NAME);
    authenticationFailureMessage = getString(
         TextFormattedAccessLogFields.BIND_AUTHENTICATION_FAILURE_REASON);
