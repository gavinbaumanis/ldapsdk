...
import com.unboundid.ldap.sdk.unboundidds.logs.v2.BindForwardAccessLogMessage;
 ...
 * text-formatted bind forward access log message.
 * <BR>
 * <BLOCKQUOTE>
...
public class TextFormattedBindForwardAccessLogMessage
       extends TextFormattedBindRequestAccessLogMessage
       implements BindForwardAccessLogMessage
{
  /**
   * The serial version UID for this serializable class.
   */
  private static final long serialVersionUID = 3760984171302708099L;
  ...
  /**
   * Creates a new text-formatted bind forward access log message from the
   ...
   *                        log message.
   */
  public TextFormattedBindForwardAccessLogMessage(
