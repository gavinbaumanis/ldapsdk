 ...
 * JSON-formatted abandon request access log message.
 * <BR>
 * <BLOCKQUOTE>
...
public class JSONAbandonRequestAccessLogMessage
       ...
       implements AbandonRequestAccessLogMessage
{
  ...
  /**
   * Creates a new JSON abandon request access log message from the provided
   * JSON object.
   *
   ...
   *                        valid log message.
   */
  public JSONAbandonRequestAccessLogMessage(
         ...
         throws LogException
  {
    ...
    messageIDToAbandon = getIntegerNoThrow(
         JSONFormattedAccessLogFields.ABANDON_MESSAGE_ID);
  }
