...
public final class SearchForwardAccessLogMessage
       extends SearchRequestAccessLogMessage
{
  ...
  /**
   * Creates a new search forward access log message from the provided message
   * string.
   *
   * @param  s  The string to be parsed as a search forward access log message.
   *
   * @throws  LogException  If the provided string cannot be parsed as a valid
   *                        log message.
   */
  public SearchForwardAccessLogMessage(@NotNull final String s)
         throws LogException
  {
  ...
  /**
   * Creates a new search forward access log message from the provided log
   * message.
   *
   * @param  m  The log message to be parsed as a search forward access log
   *            message.
   */
  public SearchForwardAccessLogMessage(@NotNull final LogMessage m)
  {
    super(m);
