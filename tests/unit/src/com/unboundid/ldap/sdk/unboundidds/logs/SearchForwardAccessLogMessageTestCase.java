 ...
 * {@code SearchForwardAccessLogMessage} class.
 */
public class SearchForwardAccessLogMessageTestCase
       extends LDAPSDKTestCase
{
         ...
         throws Exception
  {
    ...
    SearchForwardAccessLogMessage m = new SearchForwardAccessLogMessage(s);
    m = new SearchForwardAccessLogMessage(m);
         ...
         throws Exception
  {
    ...
    SimpleDateFormat f = new SimpleDateFormat("'['dd/MMM/yyyy:HH:mm:ss Z']'");
    String s = f.format(d) + " SEARCH FORWARD conn=1 op=2 msgID=3 " +
