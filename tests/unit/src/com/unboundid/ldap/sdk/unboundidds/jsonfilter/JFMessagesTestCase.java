...
/**
 * This class provides test coverage for the JFMessages class.
 */
public class JFMessagesTestCase
       extends LDAPSDKTestCase
{
  ...
  public void testMessageDefined(final JFMessages m)
         throws Exception
  {
    assertNotNull(m);

    assertEquals(JFMessages.valueOf(m.name()), m);
  ...
  {
    JFMessages[] values = JFMessages.values();
