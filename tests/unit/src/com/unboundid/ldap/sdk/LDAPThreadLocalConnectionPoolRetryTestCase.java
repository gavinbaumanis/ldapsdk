 ...
 * LDAP SDK to re-try an operation in a thread-local connection pool if the
 * attempt fails because of a connection that is no longer valid.
 */
public final class LDAPThreadLocalConnectionPoolRetryTestCase
       extends LDAPSDKTestCase
{
  ...
  public void testGetRootDSE()
         throws Exception
  {
    final LDAPThreadLocalConnectionPool pool = resetServer();
   ...
   * @throws  Exception  If an unexpected problem occurs.
   */
  private LDAPThreadLocalConnectionPool resetServer()
          throws Exception
  {
    ds.startListening();
