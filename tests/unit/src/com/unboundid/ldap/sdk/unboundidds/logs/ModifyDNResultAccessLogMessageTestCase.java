 ...
 * {@code ModifyDNResultAccessLogMessage} class.
 */
public class ModifyDNResultAccessLogMessageTestCase
       extends LDAPSDKTestCase
{
         ...
         throws Exception
  {
    ...
    ModifyDNResultAccessLogMessage m = new ModifyDNResultAccessLogMessage(s);
    m = new ModifyDNResultAccessLogMessage(m);
         ...
         throws Exception
  {
    ...
    SimpleDateFormat f = new SimpleDateFormat("'['dd/MMM/yyyy:HH:mm:ss Z']'");
    String s = f.format(d) + " MODDN RESULT conn=1 op=2 msgID=3 " +
         ...
         throws Exception
  {
    ...
    String s = f.format(d) + " MODDN RESULT " +
               ...
               "intermediateResponsesReturned=5 " +
