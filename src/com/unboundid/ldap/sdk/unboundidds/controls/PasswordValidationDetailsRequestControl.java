       ...
       extends Control
{
 ...
 private static final long serialVersionUID = -956099348044171899L;
  ...
  /**
   * Retrieves a representation of this password validation details request
   ...
   *     request control, the OID is "1.3.6.1.4.1.30221.2.5.40".
   *   </LI>
   *   <LI>
  ...
  public JSONObject toJSONControl()
  {
    return new JSONObject(
         ...
         new JSONField(JSONControlDecodeHelper.JSON_FIELD_CONTROL_NAME,
              INFO_CONTROL_NAME_PW_VALIDATION_REQUEST.get()),
   ...
   *
   * @return  The password validation details request control that was decoded
   *          from the provided JSON object.
   *
   * @throws  LDAPException  If the provided JSON object cannot be parsed as a
   *                         valid password validation details request control.
   */
  @NotNull()
  public static PasswordValidationDetailsRequestControl decodeJSONControl(
         ...
         throws LDAPException
  {
    ...
    return new PasswordValidationDetailsRequestControl(
