 ...
 * {@code CompareResultAccessLogMessage} class.
 */
public class CompareResultAccessLogMessageTestCase
       extends LDAPSDKTestCase
{
         ...
         throws Exception
  {
    ...
    CompareResultAccessLogMessage m = new CompareResultAccessLogMessage(s);
    m = new CompareResultAccessLogMessage(m);
         ...
         throws Exception
  {
    ...
    SimpleDateFormat f = new SimpleDateFormat("'['dd/MMM/yyyy:HH:mm:ss Z']'");
    String s = f.format(d) + " COMPARE RESULT conn=1 op=2 msgID=3 " +
